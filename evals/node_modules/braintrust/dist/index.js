...
function clearTestBackgroundLogger() {
  _optionalChain([_internalGetGlobalState, 'call', _34 => _34(), 'optionalAccess', _35 => _35.setOverrideBgLogger, 'call', _36 => _36(null)]);
}
...
function registerOtelFlush(callback) {
  _optionalChain([_globalState, 'optionalAccess', _37 => _37.registerOtelFlush, 'call', _38 => _38(callback)]);
  _optionalChain([_globalState, 'optionalAccess', _39 => _39.spanCache, 'optionalAccess', _40 => _40.disable, 'call', _41 => _41()]);
}
...
function _getLinkBaseUrl(state, linkArgs) {
  const appUrl = _getAppUrl(state.appUrl || _optionalChain([linkArgs, 'optionalAccess', _42 => _42.app_url]));
  const orgName = _getOrgName(state.orgName || _optionalChain([linkArgs, 'optionalAccess', _43 => _43.org_name]));
  if (!orgName) {
    return null;
  }
...
async function permalink(slug, opts) {
  ...
  const state = _nullishCoalesce(_optionalChain([opts, 'optionalAccess', _44 => _44.state]), () => ( _globalState));
  const getOrgName = async () => {
    if (_optionalChain([opts, 'optionalAccess', _45 => _45.orgName])) {
      return opts.orgName;
    }
    await state.login({});
    if (!state.orgName) {
  ...
  const getAppUrl = async () => {
    if (_optionalChain([opts, 'optionalAccess', _46 => _46.appUrl])) {
      return opts.appUrl;
    }
    await state.login({});
    if (!state.appUrl) {
...
var Logger = (_class8 = class {
   ...
   */
  log(event, options) {
    if (this.calledStartSpan && !_optionalChain([options, 'optionalAccess', _47 => _47.allowConcurrentWithSpans])) {
      throw new Error(
  ...
  startSpanImpl(args) {
    return new SpanImpl({
      ...
      ...startSpanParentArgs({
        ...
        parentSpanIds: _optionalChain([args, 'optionalAccess', _49 => _49.parentSpanIds]),
        propagatedEvent: _optionalChain([args, 'optionalAccess', _50 => _50.propagatedEvent])
      }),
...
var HTTPBackgroundLogger = (_class10 = class _HTTPBackgroundLogger {
  ...
  async flushOnce(args) {
    ...
    const batchSize = _nullishCoalesce(_optionalChain([args, 'optionalAccess', _51 => _51.batchSize]), () => ( this.defaultBatchSize));
        ...
        try {
          ...
          if (err instanceof AggregateError) {
            for (const e of err.errors) {
              _optionalChain([this, 'access', _52 => _52.onFlushError, 'optionalCall', _53 => _53(e)]);
            }
          } else {
            _optionalChain([this, 'access', _54 => _54.onFlushError, 'optionalCall', _55 => _55(err)]);
          }
...
function currentLogger(options) {
  ...
  return castLogger(state.currentLogger, _optionalChain([options, 'optionalAccess', _58 => _58.asyncFlush]));
}
function currentSpan(options) {
  const state = _nullishCoalesce(_optionalChain([options, 'optionalAccess', _59 => _59.state]), () => ( _globalState));
  return _nullishCoalesce(state.contextManager.getCurrentSpan(), () => ( NOOP_SPAN));
}
function getSpanParentObject(options) {
  const state = _nullishCoalesce(_optionalChain([options, 'optionalAccess', _60 => _60.state]), () => ( _globalState));
  const parentSpan = currentSpan({ state });
  if (!Object.is(parentSpan, NOOP_SPAN)) {
    return parentSpan;
  }
  const parentStr = _nullishCoalesce(_optionalChain([options, 'optionalAccess', _61 => _61.parent]), () => ( state.currentParent.getStore()));
...
function traced(callback, args) {
  ...
  const ret = runCatchFinally(
    () => {
      if (_nullishCoalesce(_optionalChain([args, 'optionalAccess', _62 => _62.setCurrent]), () => ( true))) {
        return withCurrent(span, callback);
      } else {
        return callback(span);
      }
  ...
  if (_optionalChain([args, 'optionalAccess', _63 => _63.asyncFlush]) === void 0 || _optionalChain([args, 'optionalAccess', _64 => _64.asyncFlush])) {
    return ret;
  } else {
    return (async () => {
      const awaitedRet = await ret;
...
function wrapTraced(fn, args) {
  ...
  const noTraceIO = _optionalChain([args, 'optionalAccess', _65 => _65.noTraceIO]) || hasExplicitInput || hasExplicitOutput;
  ...
  if (_optionalChain([args, 'optionalAccess', _66 => _66.asyncFlush])) {
...
async function flush(options) {
  const state = _nullishCoalesce(_optionalChain([options, 'optionalAccess', _67 => _67.state]), () => ( _globalState));
...
function startSpanAndIsLogger(args) {
  const state = _nullishCoalesce(_optionalChain([args, 'optionalAccess', _68 => _68.state]), () => ( _globalState));
  const parentObject = getSpanParentObject({
    asyncFlush: _optionalChain([args, 'optionalAccess', _69 => _69.asyncFlush]),
  ...
  if (parentObject instanceof SpanComponentsV3 || parentObject instanceof SpanComponentsV4) {
    ...
    const span = new SpanImpl({
      ...
      parentSpanIds,
      propagatedEvent: _nullishCoalesce(_optionalChain([args, 'optionalAccess', _71 => _71.propagatedEvent]), () => ( // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
    ...
    return {
      ...
      _optionalChain([args, 'optionalAccess', _72 => _72.asyncFlush]) === false
    };
  } else {
...
function extractAttachments(event, attachments) {
  for (const [key, value] of Object.entries(event)) {
    ...
    if (_optionalChain([value, 'optionalAccess', _73 => _73.type]) === BRAINTRUST_ATTACHMENT && value.key && !value.uploader) {
      continue;
    }
    if (_optionalChain([value, 'optionalAccess', _74 => _74.reference, 'optionalAccess', _75 => _75.type]) === BRAINTRUST_ATTACHMENT && _optionalChain([value, 'optionalAccess', _76 => _76.uploader])) {
...
var ObjectFetcher = (_class11 = class {
  ...
  async *fetch(options) {
    ...
    for await (const record of this.fetchRecordsFromApi(_optionalChain([options, 'optionalAccess', _77 => _77.batchSize]))) {
      yield record;
    }
  }
  [Symbol.asyncIterator]() {
  ...
  async fetchedData(options) {
    if (this._fetchedData === void 0) {
      const data = [];
      for await (const record of this.fetchRecordsFromApi(_optionalChain([options, 'optionalAccess', _78 => _78.batchSize]))) {
        data.push(record);
      }
...
var Experiment2 = (_class12 = class extends ObjectFetcher {
   ...
   */
  log(event, options) {
    if (this.calledStartSpan && !_optionalChain([options, 'optionalAccess', _79 => _79.allowConcurrentWithSpans])) {
      throw new Error(
  ...
  startSpanImpl(args) {
    return new SpanImpl({
      ...
      ...startSpanParentArgs({
        state: this.state,
        parent: _optionalChain([args, 'optionalAccess', _80 => _80.parent]),
        parentObjectType: this.parentObjectType(),
        parentObjectId: this.lazyId,
        parentComputeObjectMetadataArgs: void 0,
        parentSpanIds: void 0,
        propagatedEvent: _optionalChain([args, 'optionalAccess', _81 => _81.propagatedEvent])
      }),
...
var SpanImpl = (_class13 = class _SpanImpl {
  ...
  logInternal({
    ...
    if (_optionalChain([partialRecord, 'access', _82 => _82.metrics, 'optionalAccess', _83 => _83.end])) {
      this.loggedEndTime = _optionalChain([partialRecord, 'access', _84 => _84.metrics, 'optionalAccess', _85 => _85.end]);
    }
  ...
  startSpan(args) {
    const parentSpanIds = _optionalChain([args, 'optionalAccess', _86 => _86.parent]) ? void 0 : { spanId: this._spanId, rootSpanId: this._rootSpanId };
  ...
  startSpanWithParents(spanId, spanParents, args) {
    ...
    return new _SpanImpl({
      ...
      ...startSpanParentArgs({
        state: this._state,
        parent: _optionalChain([args, 'optionalAccess', _89 => _89.parent]),
        parentObjectType: this.parentObjectType,
        parentObjectId: this.parentObjectId,
        parentComputeObjectMetadataArgs: this.parentComputeObjectMetadataArgs,
        parentSpanIds,
        propagatedEvent: _nullishCoalesce(_optionalChain([args, 'optionalAccess', _90 => _90.propagatedEvent]), () => ( this.propagatedEvent))
      }),
      spanId
    });
  }
    ...
    if (!this.loggedEndTime) {
      endTime = _nullishCoalesce(_optionalChain([args, 'optionalAccess', _91 => _91.endTime]), () => ( getCurrentUnixTimestamp()));
  ...
  _link(baseUrl) {
    ...
    switch (this.parentObjectType) {
      case 2 /* PROJECT_LOGS */: {
        const projectID = _optionalChain([args, 'optionalAccess', _92 => _92.project_id]) || this.parentObjectId.getSync().value;
        const projectName = _optionalChain([args, 'optionalAccess', _93 => _93.project_name]);
        if (projectID) {
      ...
      case 1 /* EXPERIMENT */: {
        const expID = _optionalChain([args, 'optionalAccess', _94 => _94.experiment_id]) || _optionalChain([this, 'access', _95 => _95.parentObjectId, 'optionalAccess', _96 => _96.getSync, 'call', _97 => _97(), 'optionalAccess', _98 => _98.value]);
        if (!expID) {
...
var Prompt2 = (_class15 = class _Prompt {
  ...
  get prompt() {
    return _optionalChain([this, 'access', _99 => _99.getParsedPromptData, 'call', _100 => _100(), 'optionalAccess', _101 => _101.prompt]);
  }
  get version() {
    return this.metadata[TRANSACTION_ID_FIELD];
  }
  get options() {
    return _optionalChain([this, 'access', _102 => _102.getParsedPromptData, 'call', _103 => _103(), 'optionalAccess', _104 => _104.options]) || {};
  }
  get templateFormat() {
    return _optionalChain([this, 'access', _105 => _105.getParsedPromptData, 'call', _106 => _106(), 'optionalAccess', _107 => _107.template_format]);
  }
  get promptData() {
  ...
  static renderPrompt({
    ...
    if (prompt.type === "chat") {
      ...
      return {
        type: "chat",
        messages,
        ..._optionalChain([prompt, 'access', _108 => _108.tools, 'optionalAccess', _109 => _109.trim, 'call', _110 => _110()]) ? {
...
async function getPromptVersions(projectId, promptId) {
  ...
  return _optionalChain([result, 'access', _111 => _111.data, 'optionalAccess', _112 => _112.filter, 'call', _113 => _113(
    (entry) => ["upsert", "merge"].includes(_optionalChain([entry, 'access', _114 => _114.audit_data, 'optionalAccess', _115 => _115.action]))
  ), 'access', _116 => _116.map, 'call', _117 => _117((entry) => prettifyXact(entry._xact_id))]) || [];
}
...
var OpenAIPlugin = class extends BasePlugin {
  ...
  onEnable() {
    this.subscribeToStreamingChannel(
      "orchestrion:openai:chat.completions.create",
      {
        ...
        extractMetrics: (result, startTime) => {
          const metrics = parseMetricsFromUsage(_optionalChain([result, 'optionalAccess', _119 => _119.usage]));
          if (startTime) {
            metrics.time_to_first_token = getCurrentUnixTimestamp() - startTime;
          }
          return metrics;
    ...
    this.subscribeToChannel("orchestrion:openai:embeddings.create", {
      ...
      extractOutput: (result) => {
        return _optionalChain([result, 'optionalAccess', _120 => _120.data, 'optionalAccess', _121 => _121.map, 'call', _122 => _122((d) => d.embedding)]);
      },
      extractMetrics: (result) => {
        return parseMetricsFromUsage(_optionalChain([result, 'optionalAccess', _123 => _123.usage]));
      }
    });
    this.subscribeToStreamingChannel(
      "orchestrion:openai:beta.chat.completions.parse",
      {
        ...
        extractMetrics: (result, startTime) => {
          const metrics = parseMetricsFromUsage(_optionalChain([result, 'optionalAccess', _125 => _125.usage]));
          if (startTime) {
            metrics.time_to_first_token = getCurrentUnixTimestamp() - startTime;
          }
          return metrics;
    ...
    this.subscribeToStreamingChannel("orchestrion:openai:responses.create", {
      ...
      extractOutput: (result) => {
        return processImagesInOutput(_optionalChain([result, 'optionalAccess', _127 => _127.output]));
      },
      extractMetrics: (result, startTime) => {
        const metrics = parseMetricsFromUsage(_optionalChain([result, 'optionalAccess', _128 => _128.usage]));
        if (startTime) {
          metrics.time_to_first_token = getCurrentUnixTimestamp() - startTime;
        }
        return metrics;
    ...
    this.subscribeToSyncStreamChannel("orchestrion:openai:responses.stream", {
      ...
      extractFromEvent: (event) => {
        ...
        if (event.type === "response.completed") {
          const data = {};
          if (_optionalChain([response, 'optionalAccess', _129 => _129.output]) !== void 0) {
          ...
          data.metrics = parseMetricsFromUsage(_optionalChain([response, 'optionalAccess', _130 => _130.usage]));
          return data;
        }
        return {};
      }
    ...
    this.subscribeToStreamingChannel("orchestrion:openai:responses.parse", {
      ...
      extractOutput: (result) => {
        return processImagesInOutput(_optionalChain([result, 'optionalAccess', _131 => _131.output]));
      },
      extractMetrics: (result, startTime) => {
        const metrics = parseMetricsFromUsage(_optionalChain([result, 'optionalAccess', _132 => _132.usage]));
        if (startTime) {
          metrics.time_to_first_token = getCurrentUnixTimestamp() - startTime;
        }
        return metrics;
...
function aggregateChatCompletionChunks(chunks) {
  ...
  for (const chunk of chunks) {
    ...
    const delta = _optionalChain([chunk, 'access', _133 => _133.choices, 'optionalAccess', _134 => _134[0], 'optionalAccess', _135 => _135.delta]);
    if (!delta) {
      continue;
    }
    if (!role && delta.role) {
...
var AnthropicPlugin = (_class18 = class extends BasePlugin {constructor(...args2) { super(...args2); _class18.prototype.__init64.call(this); }
  ...
  subscribeToAnthropicChannels() {
    this.subscribeToStreamingChannel("orchestrion:anthropic:messages.create", {
      ...
      extractMetrics: (result, startTime) => {
        const metrics = parseMetricsFromUsage2(_optionalChain([result, 'optionalAccess', _136 => _136.usage]));
        if (startTime) {
          metrics.time_to_first_token = getCurrentUnixTimestamp() - startTime;
        }
      ...
      extractMetadata: (result) => {
        ...
        for (const m of metas) {
          if (_optionalChain([result, 'optionalAccess', _137 => _137[m]]) !== void 0) {
            metadata[m] = result[m];
          }
        }
        return metadata;
      ...
      isStreaming: (args) => {
        return _optionalChain([args, 'access', _138 => _138[0], 'optionalAccess', _139 => _139.stream]) === true;
      }
    });
    this.subscribeToStreamingChannel(
      "orchestrion:anthropic:beta.messages.create",
      {
        ...
        extractMetrics: (result, startTime) => {
          const metrics = parseMetricsFromUsage2(_optionalChain([result, 'optionalAccess', _140 => _140.usage]));
          if (startTime) {
            metrics.time_to_first_token = getCurrentUnixTimestamp() - startTime;
          }
          const finalized = finalizeAnthropicTokens(metrics);
        ...
        extractMetadata: (result) => {
          ...
          const metas = ["stop_reason", "stop_sequence"];
          for (const m of metas) {
            if (_optionalChain([result, 'optionalAccess', _141 => _141[m]]) !== void 0) {
              metadata[m] = result[m];
            }
          }
          return metadata;
        ...
        aggregateChunks: aggregateAnthropicStreamChunks,
        isStreaming: (args) => {
          return _optionalChain([args, 'access', _142 => _142[0], 'optionalAccess', _143 => _143.stream]) === true;
        }
      }
    );
  }
...
function aggregateAnthropicStreamChunks(chunks) {
  ...
  let metadata = {};
  for (const chunk of chunks) {
    switch (_optionalChain([chunk, 'optionalAccess', _144 => _144.type])) {
      case "message_start":
        if (_optionalChain([chunk, 'access', _145 => _145.message, 'optionalAccess', _146 => _146.usage])) {
          const initialMetrics = parseMetricsFromUsage2(chunk.message.usage);
          metrics = { ...metrics, ...initialMetrics };
        }
        break;
      case "content_block_delta":
        if (_optionalChain([chunk, 'access', _147 => _147.delta, 'optionalAccess', _148 => _148.type]) === "text_delta") {
          const text = _optionalChain([chunk, 'access', _149 => _149.delta, 'optionalAccess', _150 => _150.text]);
          if (text) {
            deltas.push(text);
          }
        }
...
function extractTokenMetrics(result) {
  const metrics = {};
  let usage = _optionalChain([result, 'optionalAccess', _151 => _151.totalUsage]) || _optionalChain([result, 'optionalAccess', _152 => _152.usage]);
  if (!usage && result) {
    try {
  ...
  const promptTokens = firstNumber(
    _optionalChain([usage, 'access', _153 => _153.inputTokens, 'optionalAccess', _154 => _154.total]),
    usage.inputTokens,
    usage.promptTokens,
    usage.prompt_tokens
  );
  ...
  const completionTokens = firstNumber(
    _optionalChain([usage, 'access', _155 => _155.outputTokens, 'optionalAccess', _156 => _156.total]),
    usage.outputTokens,
...
function serializeModelWithProvider(model) {
  const modelId = typeof model === "string" ? model : _optionalChain([model, 'optionalAccess', _157 => _157.modelId]);
  const explicitProvider = typeof model === "object" ? _optionalChain([model, 'optionalAccess', _158 => _158.provider]) : void 0;
  if (!modelId) {
...
function extractCostFromResult(result) {
  if (_optionalChain([result, 'optionalAccess', _159 => _159.steps]) && Array.isArray(result.steps) && result.steps.length > 0) {
    let totalCost = 0;
    let foundCost = false;
    for (const step of result.steps) {
      const gateway2 = _optionalChain([step, 'optionalAccess', _160 => _160.providerMetadata, 'optionalAccess', _161 => _161.gateway]);
      const stepCost = parseGatewayCost(_optionalChain([gateway2, 'optionalAccess', _162 => _162.cost])) || parseGatewayCost(_optionalChain([gateway2, 'optionalAccess', _163 => _163.marketCost]));
  ...
  const gateway = _optionalChain([result, 'optionalAccess', _164 => _164.providerMetadata, 'optionalAccess', _165 => _165.gateway]);
  const directCost = parseGatewayCost(_optionalChain([gateway, 'optionalAccess', _166 => _166.cost])) || parseGatewayCost(_optionalChain([gateway, 'optionalAccess', _167 => _167.marketCost]));
...
function extractUsageFromMessage(message) {
  ...
  if (message.type === "assistant") {
    usage = _optionalChain([message, 'access', _168 => _168.message, 'optionalAccess', _169 => _169.usage]);
...
async function createLLMSpanForMessages(messages, prompt, conversationHistory, options, startTime, parentSpan) {
  ...
  if (lastMessage.type !== "assistant" || !_optionalChain([lastMessage, 'access', _170 => _170.message, 'optionalAccess', _171 => _171.usage])) {
    return void 0;
  }
  ...
  const outputs = messages.map(
    (m) => _optionalChain([m, 'access', _172 => _172.message, 'optionalAccess', _173 => _173.content]) && _optionalChain([m, 'access', _174 => _174.message, 'optionalAccess', _175 => _175.role]) ? { content: m.message.content, role: m.message.role } : void 0
  ).filter((c) => c !== void 0);
  const span = startSpan({
    name: "anthropic.messages.create",
    spanAttributes: {
        ...
        if (isAsyncIterable(event.result)) {
          patchStreamIfNeeded(event.result, {
            onChunk: async (message) => {
              ...
              const { prompt, options = {} } = params;
              const messageId = _optionalChain([message, 'access', _180 => _180.message, 'optionalAccess', _181 => _181.id]);
              if (messageId && messageId !== spanData.currentMessageId) {
                if (spanData.currentMessages.length > 0) {
                  ...
                  if (_optionalChain([lastMessage, 'optionalAccess', _182 => _182.message, 'optionalAccess', _183 => _183.usage])) {
              ...
              if (message.type === "assistant" && _optionalChain([message, 'access', _184 => _184.message, 'optionalAccess', _185 => _185.usage])) {
              ...
              if (message.type === "result" && message.usage) {
                ...
                if (spanData.currentMessages.length > 0 && finalUsageMetrics.completion_tokens !== void 0) {
                  const lastMessage = spanData.currentMessages[spanData.currentMessages.length - 1];
                  if (_optionalChain([lastMessage, 'optionalAccess', _186 => _186.message, 'optionalAccess', _187 => _187.usage])) {
...
function serializeTools(params) {
  if (!_optionalChain([params, 'access', _188 => _188.config, 'optionalAccess', _189 => _189.tools])) {
    return null;
  }
  try {
...
async function registerSandbox(options) {
  const state = _nullishCoalesce(options.state, () => ( _internalGetGlobalState()));
  await state.login({
...
function initFunction({
  ...
  _optionalChain([s, 'optionalAccess', _193 => _193.spanCache, 'optionalAccess', _194 => _194.disable, 'call', _195 => _195()]);
  const f = async (input) => {
    return await invoke({
      projectName,
      slug,
...
function parseEventFromResponseCreateResult(result) {
  const data = {};
  if (_optionalChain([result, 'optionalAccess', _196 => _196.output]) !== void 0) {
    data.output = processImagesInOutput2(result.output);
  }
  if (result) {
  ...
  data.metrics = parseMetricsFromUsage3(_optionalChain([result, 'optionalAccess', _197 => _197.usage]));
  return data;
}
...
function parseEventFromResponseParseResult(result) {
  const data = {};
  if (_optionalChain([result, 'optionalAccess', _198 => _198.output]) !== void 0) {
    data.output = processImagesInOutput2(result.output);
  }
  if (result) {
    const { output: _output, usage: _usage, ...metadata } = result;
  ...
  data.metrics = parseMetricsFromUsage3(_optionalChain([result, 'optionalAccess', _199 => _199.usage]));
  return data;
}
function traceResponseCreateStream(stream, timedSpan) {
  ...
  return async function(...args) {
    ...
    if (!item || !_optionalChain([item, 'optionalAccess', _200 => _200.type]) || !_optionalChain([item, 'optionalAccess', _201 => _201.response])) {
      return result;
    }
...
function parseLogFromItem(item) {
  if (!item || !_optionalChain([item, 'optionalAccess', _202 => _202.type]) || !_optionalChain([item, 'optionalAccess', _203 => _203.response])) {
    return {};
  }
  ...
  switch (item.type) {
    case "response.completed":
      const data = {};
      if (_optionalChain([response, 'optionalAccess', _204 => _204.output]) !== void 0) {
      ...
      data.metrics = parseMetricsFromUsage3(_optionalChain([response, 'optionalAccess', _205 => _205.usage]));
      return data;
    default:
      return {};
  }
...
function wrapOpenAIv4(openai) {
  ...
  let betaProxy2;
  if (_optionalChain([openai, 'access', _206 => _206.beta, 'optionalAccess', _207 => _207.chat, 'optionalAccess', _208 => _208.completions, 'optionalAccess', _209 => _209.stream])) {
    const betaChatCompletionProxy = new Proxy(_optionalChain([openai, 'optionalAccess', _210 => _210.beta, 'optionalAccess', _211 => _211.chat, 'access', _212 => _212.completions]), {
      get(target, name, receiver) {
        const baseVal = Reflect.get(target, name, receiver);
        if (name === "parse") {
          return wrapBetaChatCompletionParse(baseVal.bind(target));
...
function logCompletionResponse(startTime, response, span) {
  const metrics = parseMetricsFromUsage3(_optionalChain([response, 'optionalAccess', _213 => _213.usage]));
  metrics.time_to_first_token = getCurrentUnixTimestamp() - startTime;
  span.log({
...
function parseBaseParams(allParams, inputField) {
  ...
  const processedInput = processAttachmentsInInput2(input);
...
function convertDataUrlToAttachment(dataUrl, filename) {
...
function processAttachmentsInInput2(input) {
  if (Array.isArray(input)) {
    return input.map(processAttachmentsInInput2);
  }
  if (isObject(input)) {
    if (input.type === "image_url" && isObject(input.image_url) && typeof input.image_url.url === "string") {
    ...
    if (input.type === "file" && isObject(input.file) && typeof input.file.file_data === "string") {
      const processedFileData = convertDataUrlToAttachment(
        input.file.file_data,
        typeof input.file.filename === "string" ? input.file.filename : void 0
      );
      const result = {
        ...input,
        file: {
    ...
    const processed = {};
    for (const [key, value] of Object.entries(input)) {
      processed[key] = processAttachmentsInInput2(value);
    }
    return processed;
  }
  return input;
...
function processEmbeddingResponse(result, span) {
  span.log({
    ...
    metrics: parseMetricsFromUsage3(_optionalChain([result, 'optionalAccess', _214 => _214.usage]))
  });
}
...
function postprocessStreamingResults(allResults) {
  ...
  for (const result of allResults) {
    if (result.usage) {
      metrics = {
        ...metrics,
        ...parseMetricsFromUsage3(_optionalChain([result, 'optionalAccess', _215 => _215.usage]))
      };
    }
    const delta = _optionalChain([result, 'access', _216 => _216.choices, 'optionalAccess', _217 => _217[0], 'optionalAccess', _218 => _218.delta]);
    if (!delta) {
      continue;
    }
    if (!role && delta.role) {
...
function isModuleNamespace(obj) {
  ...
  if (_optionalChain([obj, 'access', _219 => _219.constructor, 'optionalAccess', _220 => _220.name]) === "Module") {
    return true;
  }
  try {
  ...
  const wrapper = async function(allParams) {
    ...
    return traced(
      async (span) => {
        ...
        if (_optionalChain([gatewayInfo, 'optionalAccess', _221 => _221.provider])) {
          resolvedMetadata.provider = gatewayInfo.provider;
        }
        if (_optionalChain([gatewayInfo, 'optionalAccess', _222 => _222.model])) {
...
var resolveModel = (model, ai) => {
  ...
  const provider = _nullishCoalesce(_nullishCoalesce(globalThis.AI_SDK_DEFAULT_PROVIDER, () => ( _optionalChain([ai, 'optionalAccess', _223 => _223.gateway]))), () => ( null));
...
var wrapModel = (model, ai) => {
  ...
  const originalDoStream = _optionalChain([resolvedModel, 'access', _224 => _224.doStream, 'optionalAccess', _225 => _225.bind, 'call', _226 => _226(resolvedModel)]);
  ...
  const wrappedDoGenerate = async (options) => {
    ...
    return traced(
      async (span) => {
        ...
        const gatewayInfo = extractGatewayRoutingInfo(result);
        const resolvedMetadata = {};
        if (_optionalChain([gatewayInfo, 'optionalAccess', _227 => _227.provider])) {
          resolvedMetadata.provider = gatewayInfo.provider;
        }
        if (_optionalChain([gatewayInfo, 'optionalAccess', _228 => _228.model])) {
          resolvedMetadata.model = gatewayInfo.model;
        }
        ...
        switch (chunk.type) {
          ...
          case "raw":
            if (chunk.rawValue) {
              ...
              if (_optionalChain([rawVal, 'access', _229 => _229.delta, 'optionalAccess', _230 => _230.content])) {
                text += rawVal.delta.content;
              } else if (_optionalChain([rawVal, 'access', _231 => _231.choices, 'optionalAccess', _232 => _232[0], 'optionalAccess', _233 => _233.delta, 'optionalAccess', _234 => _234.content])) {
          ...
          case "finish":
            ...
            const resolvedMetadata = {};
            if (_optionalChain([gatewayInfo, 'optionalAccess', _235 => _235.provider])) {
              resolvedMetadata.provider = gatewayInfo.provider;
            }
            if (_optionalChain([gatewayInfo, 'optionalAccess', _236 => _236.model])) {
              resolvedMetadata.model = gatewayInfo.model;
            }
...
var wrapModelAndGetMetrics = (model, aiSDK) => {
  ...
  const modelIsWrapped = _optionalChain([wrappedModel, 'optionalAccess', _237 => _237._braintrustWrapped]) === true;
  return {
    wrappedModel,
    getMetrics: (result) => modelIsWrapped ? void 0 : extractTokenMetrics2(result)
  };
};
  ...
  return async function generateObjectWrapper(allParams) {
    ...
    return traced(
      async (span) => {
        ...
        const gatewayInfo = extractGatewayRoutingInfo(result);
        const resolvedMetadata = {};
        if (_optionalChain([gatewayInfo, 'optionalAccess', _238 => _238.provider])) {
          resolvedMetadata.provider = gatewayInfo.provider;
        }
        if (_optionalChain([gatewayInfo, 'optionalAccess', _239 => _239.model])) {
          resolvedMetadata.model = gatewayInfo.model;
        }
        span.log({
          output,
      ...
      const result = withCurrent(
        ...
        () => streamText({
          ...
          onChunk: (chunk) => {
            ...
            _optionalChain([params, 'access', _240 => _240.onChunk, 'optionalCall', _241 => _241(chunk)]);
          },
          onFinish: async (event) => {
            _optionalChain([params, 'access', _242 => _242.onFinish, 'optionalCall', _243 => _243(event)]);
            const gatewayInfo = extractGatewayRoutingInfo(event);
            const resolvedMetadata = {};
            if (_optionalChain([gatewayInfo, 'optionalAccess', _244 => _244.provider])) {
              resolvedMetadata.provider = gatewayInfo.provider;
            }
            if (_optionalChain([gatewayInfo, 'optionalAccess', _245 => _245.model])) {
              resolvedMetadata.model = gatewayInfo.model;
            }
            span.log({
          ...
          onError: async (err) => {
            _optionalChain([params, 'access', _246 => _246.onError, 'optionalCall', _247 => _247(err)]);
            span.log({
      ...
      const result = withCurrent(
        ...
        () => streamObject({
          ...
          onChunk: (chunk) => {
            ...
            _optionalChain([params, 'access', _248 => _248.onChunk, 'optionalCall', _249 => _249(chunk)]);
          },
          onFinish: async (event) => {
            _optionalChain([params, 'access', _250 => _250.onFinish, 'optionalCall', _251 => _251(event)]);
            const gatewayInfo = extractGatewayRoutingInfo(event);
            const resolvedMetadata = {};
            if (_optionalChain([gatewayInfo, 'optionalAccess', _252 => _252.provider])) {
              resolvedMetadata.provider = gatewayInfo.provider;
            }
            if (_optionalChain([gatewayInfo, 'optionalAccess', _253 => _253.model])) {
              resolvedMetadata.model = gatewayInfo.model;
            }
            span.log({
              output: await processOutput(event, options.denyOutputPaths),
          ...
          onError: async (err) => {
            _optionalChain([params, 'access', _254 => _254.onError, 'optionalCall', _255 => _255(err)]);
            span.log({
              error: serializeError(err)
            });
            span.end();
...
function serializeModelWithProvider2(model) {
  const modelId = typeof model === "string" ? model : _optionalChain([model, 'optionalAccess', _256 => _256.modelId]);
  const explicitProvider = typeof model === "object" ? _optionalChain([model, 'optionalAccess', _257 => _257.provider]) : void 0;
  if (!modelId) {
    return { model: modelId, provider: explicitProvider };
  }
...
function extractGatewayRoutingInfo(result) {
  if (_optionalChain([result, 'optionalAccess', _258 => _258.steps]) && Array.isArray(result.steps) && result.steps.length > 0) {
    const routing2 = _optionalChain([result, 'access', _259 => _259.steps, 'access', _260 => _260[0], 'optionalAccess', _261 => _261.providerMetadata, 'optionalAccess', _262 => _262.gateway, 'optionalAccess', _263 => _263.routing]);
    if (routing2) {
      return {
  ...
  const routing = _optionalChain([result, 'optionalAccess', _264 => _264.providerMetadata, 'optionalAccess', _265 => _265.gateway, 'optionalAccess', _266 => _266.routing]);
  if (routing) {
    return {
...
var isOutputObject = (value) => {
  ...
  if (typeof value.responseFormat === "function" || typeof value.responseFormat === "object") {
    return true;
  }
  return false;
};
...
var processInputAttachments2 = async (input) => {
  if (!input) return input;
  const processed = { ...input };
  if (input.messages && Array.isArray(input.messages)) {
    processed.messages = input.messages.map(processMessage);
...
var convertImageToAttachment = (image, explicitMimeType) => {
  try {
    if (typeof image === "string" && image.startsWith("data:")) {
      ...
      const mimeType = _optionalChain([mimeTypeSection, 'access', _267 => _267.match, 'call', _268 => _268(/data:(.*?);/), 'optionalAccess', _269 => _269[1]]);
...
var processOutput = async (output, denyOutputPaths) => {
  ...
  return omit2(merged, _nullishCoalesce(denyOutputPaths, () => ( DENY_OUTPUT_PATHS)));
};
...
function extractTokenMetrics2(result) {
  const metrics = {};
  let usage = _optionalChain([result, 'optionalAccess', _270 => _270.totalUsage]) || _optionalChain([result, 'optionalAccess', _271 => _271.usage]);
  if (!usage && result) {
    try {
      if ("totalUsage" in result && typeof result.totalUsage !== "function") {
        usage = result.totalUsage;
  ...
  const promptTokens = firstNumber2(
    _optionalChain([usage, 'access', _272 => _272.inputTokens, 'optionalAccess', _273 => _273.total]),
    usage.inputTokens,
    usage.promptTokens,
    usage.prompt_tokens
  );
  ...
  const completionTokens = firstNumber2(
    _optionalChain([usage, 'access', _274 => _274.outputTokens, 'optionalAccess', _275 => _275.total]),
    usage.outputTokens,
    usage.completionTokens,
    usage.completion_tokens
  );
  ...
  const promptCachedTokens = firstNumber2(
    _optionalChain([usage, 'access', _276 => _276.inputTokens, 'optionalAccess', _277 => _277.cacheRead]),
  ...
  const reasoningTokenCount = firstNumber2(
    _optionalChain([usage, 'access', _278 => _278.outputTokens, 'optionalAccess', _279 => _279.reasoning]),
...
function extractCostFromResult2(result) {
  if (_optionalChain([result, 'optionalAccess', _280 => _280.steps]) && Array.isArray(result.steps) && result.steps.length > 0) {
    let totalCost = 0;
    let foundCost = false;
    for (const step of result.steps) {
      const gateway2 = _optionalChain([step, 'optionalAccess', _281 => _281.providerMetadata, 'optionalAccess', _282 => _282.gateway]);
      const stepCost = parseGatewayCost2(_optionalChain([gateway2, 'optionalAccess', _283 => _283.cost])) || parseGatewayCost2(_optionalChain([gateway2, 'optionalAccess', _284 => _284.marketCost]));
      if (stepCost !== void 0 && stepCost > 0) {
        totalCost += stepCost;
        foundCost = true;
      }
  ...
  const gateway = _optionalChain([result, 'optionalAccess', _285 => _285.providerMetadata, 'optionalAccess', _286 => _286.gateway]);
  const directCost = parseGatewayCost2(_optionalChain([gateway, 'optionalAccess', _287 => _287.cost])) || parseGatewayCost2(_optionalChain([gateway, 'optionalAccess', _288 => _288.marketCost]));
  if (directCost !== void 0 && directCost > 0) {
    return directCost;
  }
  return void 0;
...
function wrapAISDKModel(model) {
  const m = model;
  if (_optionalChain([m, 'optionalAccess', _289 => _289.specificationVersion]) === "v1" && typeof _optionalChain([m, 'optionalAccess', _290 => _290.provider]) === "string" && typeof _optionalChain([m, 'optionalAccess', _291 => _291.modelId]) === "string") {
    ...
    try {
      ...
      span.log({
        ...
        metrics: {
          ...
          prompt_tokens: _optionalChain([ret, 'access', _292 => _292.usage, 'optionalAccess', _293 => _293.promptTokens]),
          completion_tokens: _optionalChain([ret, 'access', _294 => _294.usage, 'optionalAccess', _295 => _295.completionTokens]),
          cached: parseCachedHeader(
            _nullishCoalesce(_optionalChain([ret, 'access', _296 => _296.rawResponse, 'optionalAccess', _297 => _297.headers, 'optionalAccess', _298 => _298[X_CACHED_HEADER]]), () => ( _optionalChain([ret, 'access', _299 => _299.rawResponse, 'optionalAccess', _300 => _300.headers, 'optionalAccess', _301 => _301[LEGACY_CACHED_HEADER]])))
          )
        }
      });
      return ret;
            ...
            async flush(controller) {
              span.log({
                ...
                metrics: {
                  ...
                  prompt_tokens: _optionalChain([usage, 'optionalAccess', _302 => _302.promptTokens]),
                  completion_tokens: _optionalChain([usage, 'optionalAccess', _303 => _303.completionTokens]),
                  cached: parseCachedHeader(
                    _nullishCoalesce(_optionalChain([ret, 'access', _304 => _304.rawResponse, 'optionalAccess', _305 => _305.headers, 'optionalAccess', _306 => _306[X_CACHED_HEADER]]), () => ( _optionalChain([ret, 'access', _307 => _307.rawResponse, 'optionalAccess', _308 => _308.headers, 'optionalAccess', _309 => _309[LEGACY_CACHED_HEADER]])))
                  )
                }
              });
              end();
    ...
    switch (message.role) {
      ...
      case "assistant":
        ...
        return [
          {
            role: "assistant",
            content: _optionalChain([textPart, 'optionalAccess', _310 => _310.text]),
...
function detectProviderFromResult(result) {
  if (!_optionalChain([result, 'optionalAccess', _311 => _311.providerMetadata])) {
    return void 0;
  }
  const keys = Object.keys(result.providerMetadata);
  return _optionalChain([keys, 'optionalAccess', _312 => _312.at, 'call', _313 => _313(0)]);
}
function extractModelFromResult(result) {
  if (_optionalChain([result, 'optionalAccess', _314 => _314.response, 'optionalAccess', _315 => _315.modelId])) {
    return result.response.modelId;
  }
  if (_optionalChain([result, 'optionalAccess', _316 => _316.request, 'optionalAccess', _317 => _317.body, 'optionalAccess', _318 => _318.model])) {
    return result.request.body.model;
  }
  return void 0;
}
function extractModelFromWrapGenerateCallback(model) {
  return _optionalChain([model, 'optionalAccess', _319 => _319.modelId]);
}
...
function normalizeUsageMetrics(usage, provider, providerMetadata) {
  ...
  if (provider === "anthropic") {
    const anthropicMetadata = _optionalChain([providerMetadata, 'optionalAccess', _320 => _320.anthropic]);
  ...
  return [
    {
      index: 0,
      logprobs: null,
      finish_reason: _nullishCoalesce(normalizeFinishReason(_optionalChain([result, 'optionalAccess', _321 => _321.finishReason])), () => ( (toolCalls.length ? "tool_calls" : void 0))),
      message: {
        role: "assistant",
...
function extractToolCallsFromSteps(steps) {
  ...
  for (const step of steps) {
    const blocks = _optionalChain([step, 'optionalAccess', _322 => _322.content]);
...
function extractInput(params) {
  return _nullishCoalesce(_nullishCoalesce(_optionalChain([params, 'optionalAccess', _323 => _323.prompt]), () => ( _optionalChain([params, 'optionalAccess', _324 => _324.messages]))), () => ( _optionalChain([params, 'optionalAccess', _325 => _325.system])));
}
...
function BraintrustMiddleware(config = {}) {
  return {
    wrapGenerate: async ({
      ...
      const spanArgs = {
        name: _optionalChain([config, 'access', _326 => _326.spanInfo, 'optionalAccess', _327 => _327.name]) || "ai-sdk.doGenerate",
        spanAttributes: {
          type: "llm" /* LLM */,
          ..._optionalChain([config, 'access', _328 => _328.spanInfo, 'optionalAccess', _329 => _329.spanAttributes]) || {}
        },
        event: {
          input: processedInput,
          metadata: {
            ...extractModelParameters(params, V2_EXCLUDE_KEYS),
            ..._optionalChain([config, 'access', _330 => _330.spanInfo, 'optionalAccess', _331 => _331.metadata]) || {}
          }
        }
      };
      const span = startSpan(spanArgs);
      try {
        ...
        let toolCalls = extractToolCallsFromSteps(_optionalChain([result, 'optionalAccess', _332 => _332.steps]));
        if (!toolCalls || toolCalls.length === 0) {
          toolCalls = extractToolCallsFromBlocks(_optionalChain([result, 'optionalAccess', _333 => _333.content]));
        }
        span.log({
          output: toolCalls.length > 0 ? buildAssistantOutputWithToolCalls(result, toolCalls) : _optionalChain([result, 'optionalAccess', _334 => _334.content]),
          metadata,
    ...
    wrapStream: async ({ doStream, params }) => {
      ...
      const processedInput = processInputAttachments(rawInput);
      const spanArgs = {
        name: _optionalChain([config, 'access', _335 => _335.spanInfo, 'optionalAccess', _336 => _336.name]) || "ai-sdk.doStream",
        spanAttributes: {
          type: "llm" /* LLM */,
          ..._optionalChain([config, 'access', _337 => _337.spanInfo, 'optionalAccess', _338 => _338.spanAttributes]) || {}
        },
        event: {
          input: processedInput,
          metadata: {
            ...extractModelParameters(params, V2_EXCLUDE_KEYS),
            ..._optionalChain([config, 'access', _339 => _339.spanInfo, 'optionalAccess', _340 => _340.metadata]) || {}
          }
        }
      };
      const span = startSpan(spanArgs);
...
function createProxy(create) {
  return new Proxy(create, {
    apply(target, thisArg, argArray) {
      ...
      const input = coalesceInput2(args["messages"] || [], args["system"]);
...
function streamNextProxy(stream, sspan) {
  ...
  return async function(...args) {
    ...
    switch (_optionalChain([item, 'optionalAccess', _341 => _341.type])) {
      case "message_start":
        const msg = _optionalChain([item, 'optionalAccess', _342 => _342.message]);
        if (msg) {
      ...
      case "content_block_delta":
        ...
        if (_optionalChain([item, 'optionalAccess', _343 => _343.delta, 'optionalAccess', _344 => _344.type]) === "text_delta") {
          const text2 = _optionalChain([item, 'optionalAccess', _345 => _345.delta, 'optionalAccess', _346 => _346.text]);
          if (text2) {
            contentBlockDeltas[blockIndex].push(text2);
          }
        } else if (_optionalChain([item, 'optionalAccess', _347 => _347.delta, 'optionalAccess', _348 => _348.type]) === "input_json_delta") {
          const partialJson = _optionalChain([item, 'optionalAccess', _349 => _349.delta, 'optionalAccess', _350 => _350.partial_json]);
          if (partialJson) {
      ...
      case "content_block_stop":
        const text = _optionalChain([contentBlockDeltas, 'access', _351 => _351[blockIndex], 'optionalAccess', _352 => _352.join, 'call', _353 => _353("")]);
        if (!text) break;
        const block = contentBlocks[blockIndex];
        if (_optionalChain([block, 'optionalAccess', _354 => _354.type]) === "tool_use") {
          try {
            span.log({
              output: {
                role: item.role,
        ...
        break;
      case "message_delta":
        const usage = _optionalChain([item, 'optionalAccess', _355 => _355.usage]);
        if (usage) {
          const metrics = parseMetricsFromUsage4(usage);
          totals = { ...totals, ...metrics };
        }
        const delta = _optionalChain([item, 'optionalAccess', _356 => _356.delta]);
        if (delta) {
...
function parseEventFromMessage(message) {
  ...
  const metrics = parseMetricsFromUsage4(_optionalChain([message, 'optionalAccess', _357 => _357.usage]));
  const metas = ["stop_reason", "stop_sequence"];
  const metadata = {};
  for (const m of metas) {
    if (message[m] !== void 0) {
  ...
  const postToolUse = async (input, toolUseID) => {
    ...
    if (subAgentSpan) {
      try {
        ...
        const metadata = {};
        if (_optionalChain([response, 'optionalAccess', _358 => _358.status])) {
          metadata["claude_agent_sdk.status"] = response.status;
        }
        if (_optionalChain([response, 'optionalAccess', _359 => _359.totalDurationMs])) {
          metadata["claude_agent_sdk.duration_ms"] = response.totalDurationMs;
        }
        if (_optionalChain([response, 'optionalAccess', _360 => _360.totalToolUseCount]) !== void 0) {
          metadata["claude_agent_sdk.tool_use_count"] = response.totalToolUseCount;
        }
        subAgentSpan.log({
          output: _optionalChain([response, 'optionalAccess', _361 => _361.content]),
          metadata
        });
      } finally {
        subAgentSpan.end();
  ...
  const proxy = new Proxy(queryFn, {
    apply(target, thisArg, argArray) {
      ...
      if (promptIsAsyncIterable) {
        ...
        const capturingPrompt = (async function* () {
          ...
          try {
            ...
            _optionalChain([resolvePromptDone, 'optionalCall', _362 => _362()]);
          }
        })();
      ...
      const createLLMSpan = async () => {
        const parentToolUseId = _nullishCoalesce(_optionalChain([currentMessages, 'access', _363 => _363[0], 'optionalAccess', _364 => _364.parent_tool_use_id]), () => ( null));
        ...
        if (_optionalChain([lastMessage, 'optionalAccess', _365 => _365.message, 'optionalAccess', _366 => _366.usage])) {
      ...
      const wrappedGenerator = (async function* () {
        try {
          for await (const message of originalGenerator) {
            const currentTime = getCurrentUnixTimestamp();
            if (message.type === "assistant" && Array.isArray(_optionalChain([message, 'access', _367 => _367.message, 'optionalAccess', _368 => _368.content]))) {
              ...
              for (const block of message.message.content) {
                if (block.type === "tool_use" && block.id) {
                  ...
                  if (block.name === "Task" && _optionalChain([block, 'access', _369 => _369.input, 'optionalAccess', _370 => _370.subagent_type])) {
            ...
            const messageId = _optionalChain([message, 'access', _371 => _371.message, 'optionalAccess', _372 => _372.id]);
            if (messageId && messageId !== currentMessageId) {
              await createLLMSpan();
              currentMessageId = messageId;
              currentMessageStartTime = currentTime;
            }
            if (message.type === "assistant" && _optionalChain([message, 'access', _373 => _373.message, 'optionalAccess', _374 => _374.usage])) {
            ...
            if (message.type === "result" && message.usage) {
              ...
              if (currentMessages.length > 0 && finalUsageMetrics.completion_tokens !== void 0) {
                const lastMessage = currentMessages[currentMessages.length - 1];
                if (_optionalChain([lastMessage, 'optionalAccess', _375 => _375.message, 'optionalAccess', _376 => _376.usage])) {
...
function _buildLLMInput(prompt, conversationHistory, capturedPromptMessages) {
  ...
  if (typeof prompt === "string") {
    ...
    for (const msg of capturedPromptMessages) {
      const role = _optionalChain([msg, 'access', _377 => _377.message, 'optionalAccess', _378 => _378.role]);
      const content = _optionalChain([msg, 'access', _379 => _379.message, 'optionalAccess', _380 => _380.content]);
...
function _extractUsageFromMessage(message) {
  ...
  let usage;
  if (message.type === "assistant") {
    usage = _optionalChain([message, 'access', _381 => _381.message, 'optionalAccess', _382 => _382.usage]);
  } else if (message.type === "result") {
    usage = message.usage;
  }
  if (!usage || typeof usage !== "object") {
...
async function _createLLMSpanForMessages(messages, prompt, conversationHistory, options, startTime, capturedPromptMessages, parentSpan) {
  if (messages.length === 0) return void 0;
  const lastMessage = messages[messages.length - 1];
  if (lastMessage.type !== "assistant" || !_optionalChain([lastMessage, 'access', _383 => _383.message, 'optionalAccess', _384 => _384.usage])) {
    return void 0;
  }
  const model = lastMessage.message.model || options.model;
  ...
  const outputs = messages.map(
    (m) => _optionalChain([m, 'access', _385 => _385.message, 'optionalAccess', _386 => _386.content]) && _optionalChain([m, 'access', _387 => _387.message, 'optionalAccess', _388 => _388.role]) ? { content: m.message.content, role: m.message.role } : void 0
  ).filter((c) => c !== void 0);
  await traced(
    (llmSpan) => {
      llmSpan.log({
  ...
  return _optionalChain([lastMessage, 'access', _389 => _389.message, 'optionalAccess', _390 => _390.content]) && _optionalChain([lastMessage, 'access', _391 => _391.message, 'optionalAccess', _392 => _392.role]) ? { content: lastMessage.message.content, role: lastMessage.message.role } : void 0;
}
    ...
    return traced(
      async (span) => {
        ...
        try {
          ...
          const metrics = extractGenerateContentMetrics2(result, start);
          span.log({
            output: result,
              ...
              if (iterProp === "next") {
                ...
                return async function() {
                  ...
                  try {
                    ...
                    if (result.done && span) {
                      const { aggregated, metrics } = aggregateGenerateContentChunks2(
                        chunks,
                        start,
                        firstTokenTime
                      );
...
function serializeTools2(params) {
  if (!_optionalChain([params, 'access', _393 => _393.config, 'optionalAccess', _394 => _394.tools])) {
    return null;
  }
  try {
    return params.config.tools.map((tool) => {
...
function aggregateGenerateContentChunks2(chunks, start, firstTokenTime) {
  const end = getCurrentUnixTimestamp();
  const metrics = {
    start,
    end,
  ...
  for (const chunk of chunks) {
    ...
    if (chunk.candidates && Array.isArray(chunk.candidates)) {
      for (const candidate of chunk.candidates) {
        if (_optionalChain([candidate, 'access', _395 => _395.content, 'optionalAccess', _396 => _396.parts])) {
          for (const part of candidate.content.parts) {
            if (part.text !== void 0) {
              if (part.thought) {
                thoughtText += part.text;
  ...
  parts.push(...otherParts);
  if (parts.length > 0 && _optionalChain([lastResponse, 'optionalAccess', _397 => _397.candidates])) {
    const candidates = [];
    for (const candidate of lastResponse.candidates) {
      const candidateDict = {
        content: {
...
var FlushCoordinator = (_class24 = class {constructor() { _class24.prototype.__init76.call(this); }
  ...
  async doFlush(context, config) {
    ...
    if (summary && (_nullishCoalesce(config.displaySummary, () => ( true)))) {
...
function wrapTest(originalTest, config) {
  const wrapBare = (testFn) => {
    const wrapped = function(name, configOrFn, maybeFn) {
      ...
      if (isEnhanced && _optionalChain([testConfig, 'optionalAccess', _398 => _398.data]) && Array.isArray(testConfig.data)) {
      ...
      const testImplementation = async (vitestContext) => {
        ...
        const experiment = _optionalChain([experimentContext, 'optionalAccess', _399 => _399.experiment]);
          ...
          const result = await experiment.traced(
            async (span) => {
              ...
              try {
                ...
                if (_optionalChain([testConfig, 'optionalAccess', _400 => _400.scorers]) && testConfig.scorers.length > 0) {
                  await runScorers({
                ...
                if (_optionalChain([testConfig, 'optionalAccess', _401 => _401.scorers]) && testConfig.scorers.length > 0) {
                  await runScorers({
                    scorers: testConfig.scorers,
                    output: testResult,
                    expected: testConfig.expected,
  ...
  const wrapBare = (describeFn) => {
    const wrapped = function(suiteName, factory) {
      return describeFn(suiteName, () => {
        ...
        factory();
        if (afterAll && (_nullishCoalesce(config.displaySummary, () => ( true)))) {
          afterAll(async () => {
            ...
            if (config.onProgress) {
              config.onProgress({
                type: "suite_complete",
                suiteName,
                passed: _nullishCoalesce(_optionalChain([context, 'optionalAccess', _402 => _402.passed]), () => ( 0)),
                failed: _nullishCoalesce(_optionalChain([context, 'optionalAccess', _403 => _403.failed]), () => ( 0))
              });
            }
          });
        }
...
function wrapVitest(vitestMethods, config = {}) {
  ...
  return {
    ...
    flushExperiment: async (options) => {
      ...
      const shouldDisplaySummary = _nullishCoalesce(_nullishCoalesce(_optionalChain([options, 'optionalAccess', _404 => _404.displaySummary]), () => ( config.displaySummary)), () => ( true));
      let summary;
...
var CachedSpanFetcher = (_class27 = class {
  ...
  constructor(objectTypeOrFetchFn, objectId, rootSpanId, getState) {;_class27.prototype.__init82.call(this);_class27.prototype.__init83.call(this);
    if (typeof objectTypeOrFetchFn === "function") {
      ...
      this.fetchFn = async (spanType) => {
        ...
        return rows.filter((row) => _optionalChain([row, 'access', _405 => _405.span_attributes, 'optionalAccess', _406 => _406.purpose]) !== "scorer").map((row) => ({
          input: row.input,
          output: row.output,
  ...
  async fetchSpans(spanType) {
    ...
    for (const span of spans) {
      const type = _nullishCoalesce(_optionalChain([span, 'access', _407 => _407.span_attributes, 'optionalAccess', _408 => _408.type]), () => ( ""));
...
var LocalTrace = (_class28 = class {
  ...
  async getSpans({ spanType } = {}) {
    ...
    if (cachedSpans && cachedSpans.length > 0) {
      let spans = cachedSpans.filter(
        (span) => _optionalChain([span, 'access', _409 => _409.span_attributes, 'optionalAccess', _410 => _410.purpose]) !== "scorer"
      );
      if (spanType && spanType.length > 0) {
        spans = spans.filter(
          (span) => spanType.includes(_nullishCoalesce(_optionalChain([span, 'access', _411 => _411.span_attributes, 'optionalAccess', _412 => _412.type]), () => ( "")))
        );
      }
  ...
  async getThread(options) {
    const cacheKey = _nullishCoalesce(_optionalChain([options, 'optionalAccess', _413 => _413.preprocessor]), () => ( "project_default"));
  ...
  async fetchThread(options) {
    ...
    const result = await invoke({
      globalFunction: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _414 => _414.preprocessor]), () => ( "project_default")),
...
function validateParametersWithJsonSchema(parameters, schema) {
  ...
  if (!validate(parameters)) {
    const errorMessages = _optionalChain([validate, 'access', _415 => _415.errors, 'optionalAccess', _416 => _416.map, 'call', _417 => _417((err) => {
      const path2 = err.instancePath || "root";
      return `${path2}: ${err.message}`;
    }), 'access', _418 => _418.join, 'call', _419 => _419(", ")]);
...
async function runEvaluatorInternal(experiment, evaluator, progressReporter, filters, stream, parameters, collectResults, enableCache) {
  if (enableCache) {
    _optionalChain([(_nullishCoalesce(evaluator.state, () => ( _internalGetGlobalState()))), 'optionalAccess', _420 => _420.spanCache, 'optionalAccess', _421 => _421.start, 'call', _422 => _422()]);
  }
  try {
      ...
      async ({
        ...
        const callback = async (rootSpan) => {
          ...
          const trace = state ? new LocalTrace({
            ...
            objectId: await _asyncNullishCoalesce(await _asyncOptionalChain([parentComponents, 'optionalAccess', async _423 => _423.data, 'access', async _424 => _424.object_id]), async () => ( (experimentIdPromise ? await _asyncNullishCoalesce(await experimentIdPromise, async () => ( "")) : ""))),
              ...
              async (span) => {
                const hooksForTask = {
                  ...
                  reportProgress: (event) => {
                    _optionalChain([stream, 'optionalCall', _425 => _425({
                      ...event,
                      id: rootSpan.id,
                      origin: _optionalChain([baseEvent, 'access', _426 => _426.event, 'optionalAccess', _427 => _427.origin]),
          ...
          if (collectResults) {
            collectedResults.push({
              ...
              scores: mergedScores,
              error,
              origin: _optionalChain([baseEvent, 'access', _428 => _428.event, 'optionalAccess', _429 => _429.origin])
            });
          }
        };
        if (!experiment) {
    ...
    const enqueuePromise = (async () => {
      for await (const datum of dataIterable) {
        ...
        for (let trialIndex = 0; trialIndex < trialCount; trialIndex++) {
          ...
          scheduledTrials++;
          _optionalChain([progressReporter, 'access', _430 => _430.setTotal, 'optionalCall', _431 => _431(evaluator.evalName, scheduledTrials)]);
    ...
    if (enableCache) {
      const spanCache = _optionalChain([(_nullishCoalesce(evaluator.state, () => ( _internalGetGlobalState()))), 'optionalAccess', _432 => _432.spanCache]);
      _optionalChain([spanCache, 'optionalAccess', _433 => _433.dispose, 'call', _434 => _434()]);
      _optionalChain([spanCache, 'optionalAccess', _435 => _435.stop, 'call', _436 => _436()]);
    }
  }
}
