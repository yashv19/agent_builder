...
var workerdConfigured = false;
function configureWorkerd() {
  if (workerdConfigured) {
    return;
  }
  isomorph_default.buildType = "workerd";
  try {
  ...
  return new Proxy(create, {
    apply(target, thisArg, argArray) {
      ...
      const spanArgs = {
        ...
        event: {
          input: processAttachmentsInInput2(input),
              ...
              if (iterProp === "next") {
                ...
                return async function() {
                  ...
                  try {
                    ...
                    if (result.done && span) {
                      const { aggregated, metrics } = aggregateGenerateContentChunks(
                        chunks,
                        start,
                        firstTokenTime
                      );
