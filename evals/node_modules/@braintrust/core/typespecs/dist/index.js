...
__export(index_exports, {
  BRAINTRUST_ATTACHMENT: () => BRAINTRUST_ATTACHMENT,
  BRAINTRUST_PARAMS: () => BRAINTRUST_PARAMS,
  DEFAULT_IF_EXISTS: () => DEFAULT_IF_EXISTS,
  EXTERNAL_ATTACHMENT: () => EXTERNAL_ATTACHMENT,
  aclBatchUpdateRequestSchema: () => aclBatchUpdateRequestSchema,
  aclBatchUpdateResponseSchema: () => aclBatchUpdateResponseSchema,
  aclItemSchema: () => aclItemSchema,
  aclObjectTypeEnum: () => aclObjectTypeEnum,
  aclSchema: () => aclSchema,
  aiSecretSchema: () => aiSecretSchema,
  apiKeySchema: () => apiKeySchema,
  apiSpecEventObjectSchemas: () => apiSpecEventObjectSchemas,
  apiSpecObjectSchemas: () => apiSpecObjectSchemas,
  appLimitParamSchema: () => appLimitParamSchema,
  asyncScoringControlSchema: () => asyncScoringControlSchema,
  asyncScoringStateSchema: () => asyncScoringStateSchema,
  attachmentReferenceSchema: () => attachmentReferenceSchema,
  attachmentStatusSchema: () => attachmentStatusSchema,
  baseSSEEventSchema: () => baseSSEEventSchema,
  braintrustAttachmentReferenceSchema: () => braintrustAttachmentReferenceSchema,
  callEventSchema: () => callEventSchema,
  chatCompletionContentPartImageSchema: () => chatCompletionContentPartImageSchema,
  chatCompletionContentPartSchema: () => chatCompletionContentPartSchema,
  chatCompletionContentPartTextSchema: () => chatCompletionContentPartTextSchema,
  chatCompletionMessageParamSchema: () => chatCompletionMessageParamSchema,
  chatCompletionMessageToolCallSchema: () => chatCompletionMessageToolCallSchema,
  codeBundleSchema: () => codeBundleSchema,
  comparisonExperimentIdParamSchema: () => comparisonExperimentIdParamSchema,
  createAISecretSchema: () => createAISecretSchema,
  createApiKeyOutputSchema: () => createApiKeyOutputSchema,
  createApiKeySchema: () => createApiKeySchema,
  createDatasetSchema: () => createDatasetSchema,
  createEnvVarSchema: () => createEnvVarSchema,
  createExperimentSchema: () => createExperimentSchema,
  createFunctionSchema: () => createFunctionSchema,
  createGroupSchema: () => createGroupSchema,
  createProjectSchema: () => createProjectSchema,
  createProjectScoreSchema: () => createProjectScoreSchema,
  createProjectTagSchema: () => createProjectTagSchema,
  createPromptSchema: () => createPromptSchema,
  createSpanIframeSchema: () => createSpanIframeSchema,
  createViewSchema: () => createViewSchema,
  ...
  customTypesMode: () => customTypesMode,
  datasetEventSchema: () => datasetEventSchema,
  datasetSchema: () => datasetSchema,
  datetimeStringSchema: () => datetimeStringSchema,
  deleteAISecretSchema: () => deleteAISecretSchema,
  endingBeforeSchema: () => endingBeforeSchema,
  envVarObjectTypeEnum: () => envVarObjectTypeEnum,
  envVarSchema: () => envVarSchema,
  eventObjectType: () => eventObjectType,
  experimentEventSchema: () => experimentEventSchema,
  experimentSchema: () => experimentSchema,
  extendedSavedFunctionIdSchema: () => extendedSavedFunctionIdSchema,
  externalAttachmentReferenceSchema: () => externalAttachmentReferenceSchema,
  feedbackResponseSchema: () => feedbackResponseSchema,
  fetchEventsRequestSchema: () => fetchEventsRequestSchema,
  fetchLimitParamSchema: () => fetchLimitParamSchema,
  fetchPaginationCursorSchema: () => fetchPaginationCursorSchema,
  functionDataSchema: () => functionDataSchema,
  functionFormatEnum: () => functionFormatEnum,
  functionIdSchema: () => functionIdSchema,
  functionObjectTypeEnum: () => functionObjectTypeEnum,
  functionOutputTypeEnum: () => functionOutputTypeEnum,
  functionSchema: () => functionSchema2,
  ...
  gitFieldsSchema: () => gitFieldsSchema,
  gitMetadataSettingsSchema: () => gitMetadataSettingsSchema,
  groupSchema: () => groupSchema,
  ifExistsEnum: () => ifExistsEnum,
  insertEventsResponseSchema: () => insertEventsResponseSchema,
  invokeApiSchema: () => invokeApiSchema,
  invokeFunctionNonIdArgsSchema: () => invokeFunctionNonIdArgsSchema,
  invokeFunctionSchema: () => invokeFunctionSchema,
  invokeParent: () => invokeParent,
  jsonSchema: () => jsonSchema,
  literalSchema: () => literalSchema,
  makeObjectIdsFilterSchema: () => makeObjectIdsFilterSchema,
  maxOverWindowSchema: () => maxOverWindowSchema,
  ...
  objectReferenceSchema: () => objectReferenceSchema,
  objectTypeSummarizeResponseSchemas: () => objectTypeSummarizeResponseSchemas,
  objectTypes: () => objectTypes,
  objectTypesWithEvent: () => objectTypesWithEvent,
  onlineScoreConfigSchema: () => onlineScoreConfigSchema,
  organizationMembersSchema: () => organizationMembersSchema,
  organizationSchema: () => organizationSchema,
  patchAISecretSchema: () => patchAISecretSchema,
  patchDatasetSchema: () => patchDatasetSchema,
  patchEnvVarSchema: () => patchEnvVarSchema,
  patchExperimentSchema: () => patchExperimentSchema,
  patchGroupSchema: () => patchGroupSchema,
  patchOrganizationMembersOutputSchema: () => patchOrganizationMembersOutputSchema,
  patchOrganizationMembersSchema: () => patchOrganizationMembersSchema,
  patchOrganizationSchema: () => patchOrganizationSchema,
  patchProjectSchema: () => patchProjectSchema,
  patchProjectScoreSchema: () => patchProjectScoreSchema,
  patchProjectTagSchema: () => patchProjectTagSchema,
  patchPromptSchema: () => patchPromptSchema,
  patchRoleSchema: () => patchRoleSchema,
  patchSpanIframeSchema: () => patchSpanIframeSchema,
  patchViewSchema: () => patchViewSchema,
  permissionEnum: () => permissionEnum,
  playgroundLogsLogIdLiteralSchema: () => playgroundLogsLogIdLiteralSchema,
  projectLogsEventSchema: () => projectLogsEventSchema,
  projectLogsLogIdLiteralSchema: () => projectLogsLogIdLiteralSchema,
  projectSchema: () => projectSchema,
  projectScoreCategory: () => projectScoreCategory,
  projectScoreSchema: () => projectScoreSchema,
  projectScoreTypeEnum: () => projectScoreTypeEnum,
  projectSettingsSchema: () => projectSettingsSchema,
  projectTagSchema: () => projectTagSchema,
  promptBaseSchema: () => promptBaseSchema,
  promptBlockDataSchema: () => promptBlockDataSchema,
  promptDataSchema: () => promptDataSchema,
  promptLogIdLiteralSchema: () => promptLogIdLiteralSchema,
  promptOptionsSchema: () => promptOptionsSchema,
  promptSchema: () => promptSchema,
  promptSessionEventSchema: () => promptSessionEventSchema,
  promptSessionSchema: () => promptSessionSchema,
  repoInfoSchema: () => repoInfoSchema,
  ...
  runEvalSchema: () => runEvalSchema,
  runtimeContextSchema: () => runtimeContextSchema,
  savedFunctionIdSchema: () => savedFunctionIdSchema,
  scoreSchema: () => scoreSchema,
  spanAttributesSchema: () => spanAttributesSchema,
  spanFieldOrderItem: () => spanFieldOrderItem,
  spanIframeBaseSchema: () => spanIframeBaseSchema,
  spanIframeSchema: () => spanIframeSchema,
  spanTypeSchema: () => spanTypeSchema,
  sseConsoleEventDataSchema: () => sseConsoleEventDataSchema,
  sseConsoleEventSchema: () => sseConsoleEventSchema,
  sseDataEventSchema: () => sseDataEventSchema,
  sseDoneEventSchema: () => sseDoneEventSchema,
  sseErrorEventSchema: () => sseErrorEventSchema,
  sseProgressEventDataSchema: () => sseProgressEventDataSchema,
  sseProgressEventSchema: () => sseProgressEventSchema,
  sseStartEventSchema: () => sseStartEventSchema,
  sseTextEventSchema: () => sseTextEventSchema,
  startingAfterSchema: () => startingAfterSchema,
  streamingModeEnum: () => streamingModeEnum,
  strictPromptDataSchema: () => strictPromptDataSchema,
  ...
  uploadStatusSchema: () => uploadStatusSchema,
  useFunctionSchema: () => useFunctionSchema,
  userSchema: () => userSchema,
  validRuntimesEnum: () => validRuntimesEnum,
  versionSchema: () => versionSchema,
  viewDataSchema: () => viewDataSchema,
  viewDataSearchSchema: () => viewDataSearchSchema,
  viewOptionsSchema: () => viewOptionsSchema,
...
function objectNullish(object) {
  return new import_zod.z.ZodObject({
    ...object._def,
...
var literalSchema = import_zod2.z.union([
  import_zod2.z.string().openapi({ title: "string" }),
  import_zod2.z.number().openapi({ title: "number" }),
  import_zod2.z.boolean().openapi({ title: "boolean" }),
  import_zod2.z.null().openapi({ title: "null" })
]);
var jsonSchema = import_zod2.z.lazy(
  () => import_zod2.z.union([
    literalSchema,
    import_zod2.z.array(jsonSchema).openapi({ title: "array" }),
    import_zod2.z.record(jsonSchema).openapi({ title: "object" })
  ])
);
var datetimeStringSchema = import_zod2.z.string().transform((x, ctx) => {
  const d = new Date(x);
  if (isNaN(d.getTime())) {
    ctx.addIssue({
      code: import_zod2.z.ZodIssueCode.invalid_string,
      validation: "datetime",
...
var objectTypes = import_zod2.z.enum([
  "project",
  "experiment",
  "dataset",
  "prompt",
...
var objectTypesWithEvent = import_zod2.z.enum([
  "project",
  "experiment",
  "dataset",
  "prompt",
...
var eventObjectType = objectTypesWithEvent.exclude(["project"]).or(import_zod2.z.enum(["project_logs"]));
...
var objectReferenceSchema = import_zod2.z.object({
  object_type: eventObjectType.describe(
    "Type of the object the event is originating from."
  ),
  object_id: import_zod2.z.string().uuid().describe("ID of the object the event is originating from."),
  id: import_zod2.z.string().describe("ID of the original event."),
  _xact_id: import_zod2.z.string().describe("Transaction ID of the original event."),
  created: import_zod2.z.string().nullish().describe(
    "Created timestamp of the original event. Used to help sort in the UI"
  )
}).describe("Reference to the original object and event this was copied from.").openapi("ObjectReference");
...
var modeSchema = import_zod3.z.enum(["default", "stainless"]);
var _a;
...
var modeToTypes = {
  default: {
    unknown: import_zod3.z.unknown(),
    literalTrue: import_zod3.z.literal(true),
    literalFalse: import_zod3.z.literal(false)
  },
  stainless: {
    // Stainless requires schemas which are completely permissive to be
    // tagged.
    unknown: import_zod3.z.unknown().openapi({ ["x-stainless-any"]: true }),
    // Stainless does not support boolean literals in all SDKs.
    literalTrue: import_zod3.z.boolean(),
    literalFalse: import_zod3.z.boolean()
  }
};
...
var messageRoleSchema = import_zod4.z.enum(["system", "user", "assistant", "function", "tool", "model"]).openapi("MessageRole");
var chatCompletionSystemMessageParamSchema = import_zod4.z.object({
  content: import_zod4.z.string().default(""),
  role: import_zod4.z.literal("system"),
  name: import_zod4.z.string().optional()
});
var chatCompletionContentPartTextSchema = import_zod4.z.object({
  text: import_zod4.z.string().default(""),
  type: import_zod4.z.literal("text")
}).openapi("ChatCompletionContentPartText");
var imageURLSchema = import_zod4.z.object({
  url: import_zod4.z.string(),
  detail: import_zod4.z.union([
    import_zod4.z.literal("auto").openapi({ title: "auto" }),
    import_zod4.z.literal("low").openapi({ title: "low" }),
    import_zod4.z.literal("high").openapi({ title: "high" })
  ]).optional()
});
var chatCompletionContentPartImageSchema = import_zod4.z.object({
  image_url: imageURLSchema,
  type: import_zod4.z.literal("image_url")
}).openapi("ChatCompletionContentPartImage");
var chatCompletionContentPartSchema = import_zod4.z.union([
...
var chatCompletionContentSchema = import_zod4.z.union([
  import_zod4.z.string().default("").openapi({ title: "text" }),
  import_zod4.z.array(
...
var chatCompletionUserMessageParamSchema = import_zod4.z.object({
  content: chatCompletionContentSchema,
  role: import_zod4.z.literal("user"),
  name: import_zod4.z.string().optional()
});
var functionCallSchema = import_zod4.z.object({
  arguments: import_zod4.z.string(),
  name: import_zod4.z.string()
});
var functionSchema = import_zod4.z.object({
  arguments: import_zod4.z.string(),
  name: import_zod4.z.string()
});
var chatCompletionToolMessageParamSchema = import_zod4.z.object({
  content: import_zod4.z.string().default(""),
  role: import_zod4.z.literal("tool"),
  tool_call_id: import_zod4.z.string().default("")
});
var chatCompletionFunctionMessageParamSchema = import_zod4.z.object({
  content: import_zod4.z.string().default(""),
  name: import_zod4.z.string(),
  role: import_zod4.z.literal("function")
});
var chatCompletionMessageToolCallSchema = import_zod4.z.object({
  id: import_zod4.z.string(),
  function: functionSchema,
  type: import_zod4.z.literal("function")
}).openapi("ChatCompletionMessageToolCall");
var chatCompletionAssistantMessageParamSchema = import_zod4.z.object({
  ...
  name: import_zod4.z.string().nullish().transform((x) => x != null ? x : void 0),
  tool_calls: import_zod4.z.array(chatCompletionMessageToolCallSchema).nullish().transform((x) => x != null ? x : void 0)
});
var chatCompletionFallbackMessageParamSchema = import_zod4.z.object({
...
var chatCompletionOpenAIMessageParamSchema = import_zod4.z.union([
...
var chatCompletionMessageParamSchema = import_zod4.z.union([
...
var functionParametersSchema = import_zod6.z.record(customTypes.unknown);
var functionDefinitionSchema = import_zod6.z.object({
  name: import_zod6.z.string(),
  description: import_zod6.z.string().optional(),
  parameters: functionParametersSchema.optional()
});
var chatCompletionToolSchema = import_zod6.z.object({
  function: functionDefinitionSchema,
  type: import_zod6.z.literal("function")
});
var toolsSchema = import_zod6.z.array(chatCompletionToolSchema);

// typespecs/prompt.ts
(0, import_zod_to_openapi5.extendZodWithOpenApi)(import_zod7.z);
var promptBlockDataSchema = import_zod7.z.union([
  import_zod7.z.object({
    type: import_zod7.z.literal("completion"),
    content: import_zod7.z.string()
  }).openapi({ title: "completion" }),
  import_zod7.z.object({
    type: import_zod7.z.literal("chat"),
    messages: import_zod7.z.array(chatCompletionMessageParamSchema),
    tools: import_zod7.z.string().optional()
  }).openapi({ title: "chat" })
]);
var braintrustModelParamsSchema = import_zod7.z.object({
  use_cache: import_zod7.z.boolean().optional()
});
var BRAINTRUST_PARAMS = Object.keys(braintrustModelParamsSchema.shape);
var responseFormatJsonSchemaSchema = import_zod7.z.object({
  name: import_zod7.z.string(),
  description: import_zod7.z.string().optional(),
  schema: import_zod7.z.union([
    import_zod7.z.record(customTypes.unknown).openapi({ title: "object" }),
    import_zod7.z.string().openapi({ title: "string" })
  ]).optional(),
  strict: import_zod7.z.boolean().nullish()
});
var responseFormatSchema = import_zod7.z.union([
  import_zod7.z.object({ type: import_zod7.z.literal("json_object") }).openapi({ title: "json_object" }),
  import_zod7.z.object({
    type: import_zod7.z.literal("json_schema"),
    json_schema: responseFormatJsonSchemaSchema
  }).openapi({ title: "json_schema" }),
  import_zod7.z.object({ type: import_zod7.z.literal("text") }).openapi({ title: "text" })
]);
var openAIModelParamsSchema = import_zod7.z.object({
  temperature: import_zod7.z.number().optional(),
  top_p: import_zod7.z.number().optional(),
  max_tokens: import_zod7.z.number().optional(),
  max_completion_tokens: import_zod7.z.number().optional().describe("The successor to max_tokens"),
  frequency_penalty: import_zod7.z.number().optional(),
  presence_penalty: import_zod7.z.number().optional(),
  response_format: responseFormatSchema.nullish(),
  tool_choice: import_zod7.z.union([
    import_zod7.z.literal("auto").openapi({ title: "auto" }),
    import_zod7.z.literal("none").openapi({ title: "none" }),
    import_zod7.z.literal("required").openapi({ title: "required" }),
    import_zod7.z.object({
      type: import_zod7.z.literal("function"),
      function: import_zod7.z.object({ name: import_zod7.z.string() })
    }).openapi({ title: "function" })
  ]).optional(),
  function_call: import_zod7.z.union([
    import_zod7.z.literal("auto").openapi({ title: "auto" }),
    import_zod7.z.literal("none").openapi({ title: "none" }),
    import_zod7.z.object({
      name: import_zod7.z.string()
  ...
  n: import_zod7.z.number().optional(),
  stop: import_zod7.z.array(import_zod7.z.string()).optional(),
  reasoning_effort: import_zod7.z.enum(["low", "medium", "high"]).optional()
});
var anthropicModelParamsSchema = import_zod7.z.object({
  max_tokens: import_zod7.z.number(),
  temperature: import_zod7.z.number(),
  top_p: import_zod7.z.number().optional(),
  top_k: import_zod7.z.number().optional(),
  stop_sequences: import_zod7.z.array(import_zod7.z.string()).optional(),
  max_tokens_to_sample: import_zod7.z.number().optional().describe("This is a legacy parameter that should not be used.")
}).openapi("AntrhopicModelParams");
var googleModelParamsSchema = import_zod7.z.object({
  temperature: import_zod7.z.number().optional(),
  maxOutputTokens: import_zod7.z.number().optional(),
  topP: import_zod7.z.number().optional(),
  topK: import_zod7.z.number().optional()
}).openapi("GoogleModelParams");
var windowAIModelParamsSchema = import_zod7.z.object({
  temperature: import_zod7.z.number().optional(),
  topK: import_zod7.z.number().optional()
}).openapi("WindowAIModelParams");
var jsCompletionParamsSchema = import_zod7.z.object({}).openapi("JsCompletionParams");
var modelParamsSchema = import_zod7.z.union([
...
var _anyModelParamsSchema = openAIModelParamsSchema.merge(anthropicModelParamsSchema).merge(googleModelParamsSchema).merge(braintrustModelParamsSchema);
var promptOptionsSchema = import_zod7.z.object({
  model: import_zod7.z.string().optional(),
  params: modelParamsSchema.optional(),
  position: import_zod7.z.string().optional()
}).openapi("PromptOptions");
var promptParserSchema = import_zod7.z.object({
  type: import_zod7.z.literal("llm_classifier"),
  use_cot: import_zod7.z.boolean(),
  choice_scores: import_zod7.z.record(import_zod7.z.number().min(0).max(1))
});
var promptDataSchema = import_zod7.z.object({
  ...
  tool_functions: import_zod7.z.array(savedFunctionIdSchema).nullish(),
  origin: import_zod7.z.object({
    prompt_id: import_zod7.z.string().optional(),
    project_id: import_zod7.z.string().optional(),
    prompt_version: import_zod7.z.string().optional()
  }).nullish()
}).openapi("PromptData");
...
var viewTypeEnum = import_zod8.z.enum([
  "projects",
  "experiments",
  "experiment",
  "playgrounds",
...
var viewDataSearchSchema = import_zod8.z.object({
  filter: import_zod8.z.array(customTypes.unknown).nullish(),
  tag: import_zod8.z.array(customTypes.unknown).nullish(),
  match: import_zod8.z.array(customTypes.unknown).nullish(),
  sort: import_zod8.z.array(customTypes.unknown).nullish()
}).strip().openapi("ViewDataSearch");
var viewDataSchema = import_zod8.z.object({
  search: viewDataSearchSchema.nullish()
}).strip().openapi("ViewData");
var viewOptionsSchema = import_zod8.z.object({
  columnVisibility: import_zod8.z.record(import_zod8.z.boolean()).nullish(),
  columnOrder: import_zod8.z.array(import_zod8.z.string()).nullish(),
  columnSizing: import_zod8.z.record(import_zod8.z.number()).nullish(),
  grouping: import_zod8.z.string().nullish(),
  rowHeight: import_zod8.z.string().nullish(),
  layout: import_zod8.z.string().nullish()
...
(0, import_zod_to_openapi6.extendZodWithOpenApi)(import_zod9.z);
var repoInfoSchema = import_zod9.z.object({
  commit: import_zod9.z.string().nullish().describe("SHA of most recent commit"),
  branch: import_zod9.z.string().nullish().describe("Name of the branch the most recent commit belongs to"),
  tag: import_zod9.z.string().nullish().describe("Name of the tag on the most recent commit"),
  dirty: import_zod9.z.boolean().nullish().describe(
    "Whether or not the repo had uncommitted changes when snapshotted"
  ),
  author_name: import_zod9.z.string().nullish().describe("Name of the author of the most recent commit"),
  author_email: import_zod9.z.string().nullish().describe("Email of the author of the most recent commit"),
  commit_message: import_zod9.z.string().nullish().describe("Most recent commit message"),
  commit_time: import_zod9.z.string().nullish().describe("Time of the most recent commit"),
  git_diff: import_zod9.z.string().nullish().describe(
...
var collectMetadataEnum = import_zod9.z.enum(["all", "none", "some"]);
var gitMetadataSettingsSchema = import_zod9.z.strictObject({
  collect: collectMetadataEnum,
  fields: import_zod9.z.array(gitFieldsSchema).optional()
});

// typespecs/functions.ts
(0, import_zod_to_openapi7.extendZodWithOpenApi)(import_zod10.z);
var validRuntimesEnum = import_zod10.z.enum(["node", "python"]);
var functionTypeEnum = import_zod10.z.enum(["llm", "scorer", "task", "tool"]);
var runtimeContextSchema = import_zod10.z.object({
  runtime: validRuntimesEnum,
  version: import_zod10.z.string()
});
var functionIdSchema = import_zod10.z.union([
  import_zod10.z.object({
    function_id: import_zod10.z.string().describe("The ID of the function"),
    version: import_zod10.z.string().optional().describe("The version of the function")
  }).describe("Function id").openapi({ title: "function_id" }),
  import_zod10.z.object({
    project_name: import_zod10.z.string().describe("The name of the project containing the function"),
    slug: import_zod10.z.string().describe("The slug of the function"),
    version: import_zod10.z.string().optional().describe("The version of the function")
  }).describe("Project name and slug").openapi({ title: "project_slug" }),
  import_zod10.z.object({
    global_function: import_zod10.z.string().describe(
  ...
  import_zod10.z.object({
    prompt_session_id: import_zod10.z.string().describe("The ID of the prompt session"),
    prompt_session_function_id: import_zod10.z.string().describe("The ID of the function in the prompt session"),
    version: import_zod10.z.string().optional().describe("The version of the function")
  }).describe("Prompt session id").openapi({ title: "prompt_session_id" }),
  import_zod10.z.object({
    inline_context: runtimeContextSchema,
    code: import_zod10.z.string().describe("The inline code to execute"),
    name: import_zod10.z.string().nullish().describe("The name of the inline code function")
  }).describe("Inline code function").openapi({ title: "inline_code" }),
  import_zod10.z.object({
    inline_prompt: promptDataSchema,
    name: import_zod10.z.string().nullish().describe("The name of the inline prompt")
...
var streamingModeEnum = import_zod10.z.enum(["auto", "parallel"]);
var invokeParent = import_zod10.z.union([
  import_zod10.z.object({
    object_type: import_zod10.z.enum(["project_logs", "experiment", "playground_logs"]),
    object_id: import_zod10.z.string().describe("The id of the container object you are logging to"),
    row_ids: import_zod10.z.object({
      id: import_zod10.z.string().describe("The id of the row"),
      span_id: import_zod10.z.string().describe("The span_id of the row"),
      root_span_id: import_zod10.z.string().describe("The root_span_id of the row")
    }).nullish().describe("Identifiers for the row to to log a subspan under"),
    propagated_event: import_zod10.z.record(customTypes.unknown).nullish().describe(
      "Include these properties in every span created under this parent"
    )
  }).describe("Span parent properties").openapi({ title: "span_parent_struct" }),
  import_zod10.z.string().optional().describe(
    "The parent's span identifier, created by calling `.export()` on a span"
  )
]);
var invokeFunctionNonIdArgsSchema = import_zod10.z.object({
  input: customTypes.unknown.optional().describe(
    "Argument to the function, which can be any JSON serializable value"
  ),
  expected: customTypes.unknown.optional().describe("The expected output of the function"),
  metadata: import_zod10.z.record(import_zod10.z.string(), import_zod10.z.unknown()).nullish().describe("Any relevant metadata"),
  messages: import_zod10.z.array(chatCompletionMessageParamSchema).optional().describe(
    "If the function is an LLM, additional messages to pass along to it"
  ),
  parent: invokeParent.describe("Options for tracing the function call"),
  stream: import_zod10.z.boolean().nullish().describe(
...
var runEvalSchema = import_zod10.z.object({
  project_id: import_zod10.z.string().describe("Unique identifier for the project to run the eval in"),
  data: import_zod10.z.union([
    import_zod10.z.object({
      dataset_id: import_zod10.z.string(),
      _internal_btql: import_zod10.z.record(import_zod10.z.string(), import_zod10.z.unknown()).nullish()
    }).describe("Dataset id").openapi({ title: "dataset_id" }),
    import_zod10.z.object({
      project_name: import_zod10.z.string(),
      dataset_name: import_zod10.z.string(),
      _internal_btql: import_zod10.z.record(import_zod10.z.string(), import_zod10.z.unknown()).nullish()
    }).describe("Project and dataset name").openapi({ title: "project_dataset_name" }),
    import_zod10.z.object({
      data: import_zod10.z.array(import_zod10.z.unknown())
      // TODO: More specific schema for these?
    }).describe("Dataset rows").openapi({ title: "dataset_rows" })
  ]).describe("The dataset to use"),
  task: functionIdSchema.describe("The function to evaluate"),
  scores: import_zod10.z.array(functionIdSchema).describe("The functions to score the eval on"),
  experiment_name: import_zod10.z.string().optional().describe(
  ...
  metadata: import_zod10.z.record(customTypes.unknown).optional().describe(
  ...
  stream: import_zod10.z.boolean().optional().describe(
  ...
  trial_count: import_zod10.z.number().nullish().describe(
  ...
  is_public: import_zod10.z.boolean().nullish().describe("Whether the experiment should be public. Defaults to false."),
  timeout: import_zod10.z.number().nullish().describe(
    "The maximum duration, in milliseconds, to run the evaluation. Defaults to undefined, in which case there is no timeout."
  ),
  max_concurrency: import_zod10.z.number().nullish().describe(
  ...
  base_experiment_name: import_zod10.z.string().nullish().describe(
  ...
  base_experiment_id: import_zod10.z.string().nullish().describe(
...
var baseSSEEventSchema = import_zod10.z.object({
  id: import_zod10.z.string().optional(),
  data: import_zod10.z.string()
});
var sseTextEventSchema = baseSSEEventSchema.merge(
  import_zod10.z.object({
    event: import_zod10.z.literal("text_delta")
  })
);
var sseDataEventSchema = baseSSEEventSchema.merge(
  import_zod10.z.object({
    event: import_zod10.z.literal("json_delta")
  })
);
var sseErrorEventSchema = baseSSEEventSchema.merge(
  import_zod10.z.object({
    event: import_zod10.z.literal("error")
  })
);
var sseProgressEventSchema = baseSSEEventSchema.merge(
  import_zod10.z.object({
    event: import_zod10.z.literal("progress")
  })
);
var sseConsoleEventSchema = baseSSEEventSchema.merge(
  import_zod10.z.object({
    event: import_zod10.z.literal("console")
  })
);
var sseStartEventSchema = baseSSEEventSchema.omit({ data: true }).merge(
  import_zod10.z.object({
    event: import_zod10.z.literal("start"),
    data: import_zod10.z.literal("")
  })
);
var sseDoneEventSchema = baseSSEEventSchema.omit({ data: true }).merge(
  import_zod10.z.object({
    event: import_zod10.z.literal("done"),
    data: import_zod10.z.literal("")
  })
);
var functionObjectTypeEnum = import_zod10.z.enum(["prompt", "tool", "scorer", "task"]).openapi("FunctionObjectType");
var functionFormatEnum = import_zod10.z.enum(["llm", "code", "global"]).openapi("FunctionFormat");
var functionOutputTypeEnum = import_zod10.z.enum(["completion", "score", "any"]).openapi("FunctionOutputType");
var sseProgressEventDataSchema = import_zod10.z.object({
  id: import_zod10.z.string().describe("The id of the span this event is for"),
...
var sseConsoleEventDataSchema = import_zod10.z.object({
  stream: import_zod10.z.enum(["stderr", "stdout"]),
  message: import_zod10.z.string()
});
var callEventSchema = import_zod10.z.union([
...
var scoreSchema = import_zod10.z.union([
  import_zod10.z.object({
    name: import_zod10.z.string(),
    score: import_zod10.z.number().min(0).max(1).nullable().default(null),
    // Sometimes we get an empty value over the wire
    metadata: import_zod10.z.record(customTypes.unknown).optional().transform((data) => data != null ? data : void 0)
  }),
  import_zod10.z.number().min(0).max(1),
  import_zod10.z.boolean().transform((b) => b ? 1 : 0),
  import_zod10.z.null()
]).openapi("ScorerScore");
var ifExistsEnum = import_zod10.z.enum(["error", "ignore", "replace"]);
var DEFAULT_IF_EXISTS = "error";
var toolFunctionDefinitionSchema = import_zod10.z.object({
  type: import_zod10.z.literal("function"),
  function: import_zod10.z.object({
    name: import_zod10.z.string(),
    description: import_zod10.z.string().optional(),
    parameters: import_zod10.z.record(import_zod10.z.unknown()).optional(),
    strict: import_zod10.z.boolean().optional()
  })
});

// typespecs/app_types.ts
(0, import_zod_to_openapi8.extendZodWithOpenApi)(import_zod11.z);
function generateBaseTableSchema(objectName, opts) {
  ...
  return import_zod11.z.object({
    id: import_zod11.z.string().uuid().describe(`Unique identifier for the ${objectName}`),
    project_id: import_zod11.z.string().uuid().describe(
      `Unique identifier for the project that the ${objectName} belongs under`
    ),
    name: import_zod11.z.string().describe(nameDescription),
    description: import_zod11.z.string().nullish().describe(`Textual description of the ${objectName}`),
    ...
    updated_at: datetimeStringSchema.nullish().describe(`Date of last ${objectName} update`),
    user_id: import_zod11.z.string().uuid().nullish().describe(`Identifies the user who created the ${objectName}`),
    metadata: import_zod11.z.record(customTypes.unknown).nullish().describe(`User-controlled metadata about the ${objectName}`)
  });
}
var aclObjectTypeEnum = import_zod11.z.enum([
  "organization",
  "project",
  "experiment",
  "dataset",
...
var userSchema = import_zod11.z.object({
  ...
  given_name: import_zod11.z.string().nullish().describe("Given name of the user"),
  family_name: import_zod11.z.string().nullish().describe("Family name of the user"),
  email: import_zod11.z.string().nullish().describe("The user's email"),
  avatar_url: import_zod11.z.string().nullish().describe("URL of the user's Avatar image"),
  created: userBaseSchema.shape.created
}).openapi("User");
var organizationBaseSchema = generateBaseTableSchema("organization");
var organizationSchema = import_zod11.z.object({
  id: organizationBaseSchema.shape.id,
  name: organizationBaseSchema.shape.name,
  api_url: import_zod11.z.string().nullish(),
  is_universal_api: import_zod11.z.boolean().nullish(),
  proxy_url: import_zod11.z.string().nullish(),
  realtime_url: import_zod11.z.string().nullish(),
  created: organizationBaseSchema.shape.created
}).openapi("Organization");
var maxOverWindowSchema = import_zod11.z.object({
  window_size_days: import_zod11.z.number().int().positive(),
  max_value: import_zod11.z.number().nonnegative()
}).openapi("MaxOverWindow");
var resourcesSchema = import_zod11.z.object({
  org_id: organizationSchema.shape.id,
  forbid_toggle_experiment_public_to_private: import_zod11.z.boolean().nullish(),
  num_private_experiment_row_actions: maxOverWindowSchema.nullish(),
  forbid_insert_datasets: import_zod11.z.boolean().nullish(),
  forbid_insert_prompt_sessions: import_zod11.z.boolean().nullish(),
  forbid_access_sql_explorer: import_zod11.z.boolean().nullish(),
  num_production_log_row_actions: maxOverWindowSchema.nullish(),
  num_dataset_row_actions: maxOverWindowSchema.nullish()
}).openapi("Resources");
var memberSchema = import_zod11.z.object({
  org_id: organizationSchema.shape.id,
  user_id: userSchema.shape.id
}).openapi("Member");
var aiSecretBaseSchema = generateBaseTableSchema("AI secret");
var aiSecretSchema = import_zod11.z.object({
  ...
  type: import_zod11.z.string().nullish(),
  metadata: import_zod11.z.record(customTypes.unknown).nullish(),
  preview_secret: import_zod11.z.string().nullish()
}).openapi("AISecret");
var envVarObjectTypeEnum = import_zod11.z.enum(["organization", "project", "function"]).describe("The type of the object the environment variable is scoped for");
var envVarBaseSchema = generateBaseTableSchema("environment variable");
var envVarSchema = import_zod11.z.object({
  id: envVarBaseSchema.shape.id,
  object_type: envVarObjectTypeEnum,
  object_id: import_zod11.z.string().uuid().describe("The id of the object the environment variable is scoped for"),
  name: import_zod11.z.string().describe("The name of the environment variable"),
...
var customColumnSchema = import_zod11.z.object({
  id: customColumnBaseSchema.shape.id,
  object_type: aclObjectTypeEnum,
  object_id: import_zod11.z.string().uuid().describe("The id of the object the custom column is scoped for"),
  subtype: aclObjectTypeEnum.nullable(),
  name: import_zod11.z.string().describe("The name of the custom column"),
  expr: import_zod11.z.string().describe(
...
var apiKeySchema = import_zod11.z.object({
  ...
  preview_name: import_zod11.z.string(),
  user_id: userSchema.shape.id.nullish(),
  org_id: organizationSchema.shape.id.nullish()
}).openapi("ApiKey");
var spanFieldOrderItem = import_zod11.z.object({
  object_type: import_zod11.z.string(),
  column_id: import_zod11.z.string(),
  position: import_zod11.z.string(),
  layout: import_zod11.z.literal("full").or(import_zod11.z.literal("two_column")).nullish()
});
var projectSettingsSchema = import_zod11.z.object({
  comparison_key: import_zod11.z.string().nullish().describe("The key used to join two experiments (defaults to `input`)"),
  baseline_experiment_id: import_zod11.z.string().uuid().nullish().describe(
    "The id of the experiment to use as the default baseline for comparisons"
  ),
  spanFieldOrder: import_zod11.z.array(spanFieldOrderItem).nullish().describe("The order of the fields to display in the trace view")
}).openapi("ProjectSettings");
var projectBaseSchema = generateBaseTableSchema("project");
var projectSchema = import_zod11.z.object({
  id: projectBaseSchema.shape.id,
  org_id: import_zod11.z.string().uuid().describe(
...
var datasetSchema = import_zod11.z.object({
...
var promptLogIdLiteralSchema = import_zod11.z.literal("p").describe("A literal 'p' which identifies the object as a project prompt");
var playgroundLogsLogIdLiteralSchema = import_zod11.z.literal("x").describe("A literal 'x' which identifies the object as a playground log");
var promptBaseSchema = generateBaseTableSchema("prompt");
var promptSchemaObject = import_zod11.z.object({
  id: promptBaseSchema.shape.id,
  // This has to be copy/pasted because zod blows up when there are circular dependencies
  _xact_id: import_zod11.z.string().describe(
  ...
  slug: import_zod11.z.string().describe("Unique identifier for the prompt"),
  ...
  tags: import_zod11.z.array(import_zod11.z.string()).nullish().describe("A list of tags for the prompt"),
...
var codeBundleSchema = import_zod11.z.object({
  runtime_context: runtimeContextSchema,
  location: import_zod11.z.union([
    import_zod11.z.object({
      type: import_zod11.z.literal("experiment"),
      eval_name: import_zod11.z.string(),
      position: import_zod11.z.union([
        import_zod11.z.object({ type: import_zod11.z.literal("task") }),
        import_zod11.z.object({
          type: import_zod11.z.literal("scorer"),
          index: import_zod11.z.number().int().nonnegative()
        }).openapi({ title: "scorer" })
      ])
    }).openapi({ title: "experiment" }),
    import_zod11.z.object({
      type: import_zod11.z.literal("function"),
      index: import_zod11.z.number().int().nonnegative()
    }).openapi({ title: "function" })
  ]),
  bundle_id: import_zod11.z.string(),
  preview: import_zod11.z.string().nullish().describe("A preview of the code")
}).openapi("CodeBundle");
var functionDataSchema = import_zod11.z.union([
  import_zod11.z.object({
    type: import_zod11.z.literal("prompt")
    // For backwards compatibility reasons, the prompt definition is hoisted out and stored
    // in the outer object
  }).openapi({ title: "prompt" }),
  import_zod11.z.object({
    type: import_zod11.z.literal("code"),
    data: import_zod11.z.union([
      import_zod11.z.object({
        type: import_zod11.z.literal("bundle")
      }).and(codeBundleSchema).openapi({ title: "bundle" }),
      import_zod11.z.object({
        type: import_zod11.z.literal("inline"),
        runtime_context: runtimeContextSchema,
  ...
  import_zod11.z.object({
    type: import_zod11.z.literal("global"),
...
var functionSchema2 = promptSchemaObject.merge(
  import_zod11.z.object({
    ...
    origin: import_zod11.z.object({
      object_type: aclObjectTypeEnum,
      object_id: import_zod11.z.string().uuid().describe("Id of the object the function is originating from"),
      internal: import_zod11.z.boolean().nullish().describe(
        "The function exists for internal purposes and should not be displayed in the list of functions."
      )
    }).nullish(),
    function_schema: import_zod11.z.object({
...
var experimentSchema = import_zod11.z.object({
  ...
  commit: import_zod11.z.string().nullish().describe("Commit, taken directly from `repo_info.commit`"),
  base_exp_id: import_zod11.z.string().uuid().nullish().describe(
    "Id of default base experiment to compare against when viewing this experiment"
  ),
  deleted_at: experimentBaseSchema.shape.deleted_at,
  dataset_id: import_zod11.z.string().uuid().nullish().describe(
    "Identifier of the linked dataset, or null if the experiment is not linked to a dataset"
  ),
  dataset_version: import_zod11.z.string().nullish().describe(
    "Version number of the linked dataset the experiment was run against. This can be used to reproduce the experiment after the dataset has been modified."
  ),
  public: import_zod11.z.boolean().describe(
...
var promptSessionSchema = import_zod11.z.object({
...
var permissionEnum = import_zod11.z.enum([
  "create",
  "read",
  "update",
  "delete",
...
var roleSchema = import_zod11.z.object({
  id: roleBaseSchema.shape.id,
  org_id: import_zod11.z.string().uuid().nullish().describe(
    [
  ...
  member_permissions: import_zod11.z.array(
    import_zod11.z.object({
  ...
  member_roles: import_zod11.z.array(import_zod11.z.string().uuid()).nullish().describe(
    [
...
var groupSchema = import_zod11.z.object({
  ...
  member_users: import_zod11.z.array(import_zod11.z.string().uuid()).nullish().describe("Ids of users which belong to this group"),
  member_groups: import_zod11.z.array(import_zod11.z.string().uuid()).nullish().describe(
    [
...
var projectScoreTypeEnum = import_zod11.z.enum([
  "slider",
  "categorical",
  "weighted",
  "minimum",
  ...
  "online",
  "free-form"
]).describe("The type of the configured score").openapi("ProjectScoreType");
var projectScoreCategory = import_zod11.z.object({
  name: import_zod11.z.string().describe("Name of the category"),
  value: import_zod11.z.number().describe(
    "Numerical value of the category. Must be between 0 and 1, inclusive"
  )
}).describe("For categorical-type project scores, defines a single category").openapi("ProjectScoreCategory");
var onlineScoreConfigSchema = import_zod11.z.object({
  sampling_rate: import_zod11.z.number().min(0).max(1).describe("The sampling rate for online scoring"),
  scorers: import_zod11.z.array(savedFunctionIdSchema).describe("The list of scorers to use for online scoring"),
  apply_to_root_span: import_zod11.z.boolean().nullish().describe(
    "Whether to trigger online scoring on the root span of each trace"
  ),
  apply_to_span_names: import_zod11.z.string().array().nullish().describe("Trigger online scoring on any spans with a name in this list")
}).refine((val) => {
  var _a2;
...
var projectScoreSchema = import_zod11.z.object({
...
var projectTagSchema = import_zod11.z.object({
  ...
  color: import_zod11.z.string().nullish().describe("Color of the tag for the UI")
}).describe(
...
var spanIframeSchema = import_zod11.z.object({
  ...
  url: import_zod11.z.string().describe("URL to embed the project viewer in an iframe"),
  post_message: import_zod11.z.boolean().nullish().describe(
...
var viewSchema = import_zod11.z.object({
  id: viewBaseSchema.shape.id,
  object_type: aclObjectTypeEnum,
  object_id: import_zod11.z.string().uuid().describe("The id of the object the view applies to"),
...
var aclSchema = import_zod11.z.object({
  id: aclBaseSchema.shape.id,
  object_type: aclObjectTypeEnum,
  object_id: import_zod11.z.string().uuid().describe("The id of the object the ACL applies to"),
  user_id: import_zod11.z.string().uuid().nullish().describe(
    "Id of the user the ACL applies to. Exactly one of `user_id` and `group_id` will be provided"
  ),
  group_id: import_zod11.z.string().uuid().nullish().describe(
  ...
  role_id: import_zod11.z.string().uuid().nullish().describe(
    "Id of the role the ACL grants. Exactly one of `permission` and `role_id` will be provided"
  ),
  _object_org_id: import_zod11.z.string().uuid().describe("The organization the ACL's referred object belongs to"),
...
var appLimitParamSchema = import_zod11.z.coerce.number().int().nonnegative().describe("Limit the number of objects to return").openapi("AppLimit");
function generateBaseTableOpSchema(objectName) {
  return import_zod11.z.object({
    org_name: import_zod11.z.string().nullish().describe(
...
var startingAfterSchema = import_zod11.z.string().uuid().describe(
  [
    "Pagination cursor id.",
    "For example, if the final item in the last page you fetched had an id of `foo`, pass `starting_after=foo` to fetch the next page. Note: you may only pass one of `starting_after` and `ending_before`"
  ].join("\n\n")
).openapi("StartingAfter");
var endingBeforeSchema = import_zod11.z.string().uuid().describe(
  [
    "Pagination cursor id.",
...
function makeObjectIdsFilterSchema(objectName) {
  const item = import_zod11.z.string().uuid();
  return import_zod11.z.union([item, item.array()]).describe(
...
var createExperimentSchema = import_zod11.z.object({
  ...
  ensure_new: import_zod11.z.boolean().nullish().describe(
...
var createDatasetSchema = import_zod11.z.object({
...
var patchDatasetSchema = import_zod11.z.object({
...
var patchPromptSchema = import_zod11.z.object({
...
var patchFunctionSchema = import_zod11.z.object({
...
var createRoleSchema = import_zod11.z.object({
...
var createGroupSchema = import_zod11.z.object({
...
var aclBatchUpdateRequestSchema = import_zod11.z.object({
  add_acls: aclItemSchema.array().nullish(),
  remove_acls: aclItemSchema.array().nullish()
}).openapi("AclBatchUpdateRequest");
var aclBatchUpdateResponseSchema = import_zod11.z.object({
...
var createProjectTagSchema = import_zod11.z.object({
...
var patchProjectTagSchema = import_zod11.z.object({
...
var patchSpanIframeSchema = import_zod11.z.object({
...
var patchViewSchema = import_zod11.z.object({
...
var deleteViewSchema = import_zod11.z.object({
  object_type: viewSchema.shape.object_type,
  object_id: viewSchema.shape.object_id
}).openapi("DeleteView");
var patchOrganizationSchema = import_zod11.z.object({
...
var createApiKeySchema = import_zod11.z.object({
  name: import_zod11.z.string().describe("Name of the api key. Does not have to be unique"),
  org_name: createApiKeyBaseSchema.shape.org_name
});
var createApiKeyOutputSchema = apiKeySchema.merge(
  import_zod11.z.object({
    key: import_zod11.z.string().describe("The raw API key. It will only be exposed this one time")
  })
).openapi("CreateApiKeyOutput");
var organizationMembersSchema = import_zod11.z.object({
  members: userSchema.pick({ id: true, email: true }).array()
}).openapi("OrganizationMembers");
var patchOrganizationMembersSchema = import_zod11.z.object({
  invite_users: import_zod11.z.object({
    ...
    send_invite_emails: import_zod11.z.boolean().nullish().describe(
  ...
  remove_users: import_zod11.z.object({
  ...
  org_id: import_zod11.z.string().nullish().describe(
...
var patchOrganizationMembersOutputSchema = import_zod11.z.object({
  status: import_zod11.z.literal("success"),
  org_id: import_zod11.z.string().describe("The id of the org that was modified."),
  send_email_error: import_zod11.z.string().nullish().describe(
...
var deleteAISecretSchema = import_zod11.z.object({
  name: aiSecretSchema.shape.name,
  org_name: createAISecretBaseSchema.shape.org_name
}).openapi("DeleteAISecret");
var patchAISecretSchema = import_zod11.z.object({
  name: aiSecretSchema.shape.name.nullish(),
  type: aiSecretSchema.shape.type,
  metadata: aiSecretSchema.shape.metadata,
  secret: import_zod11.z.string().nullish()
}).openapi("PatchAISecret");
var createEnvVarSchema = envVarSchema.pick({ object_type: true, object_id: true, name: true }).extend({
  value: import_zod11.z.string().nullish().describe(
...
// typespecs/api_types.ts
(0, import_zod_to_openapi9.extendZodWithOpenApi)(import_zod12.z);
var auditSourcesSchema = import_zod12.z.enum(VALID_SOURCES);
var spanTypeSchema = import_zod12.z.enum(spanTypeAttributeValues).openapi("SpanType");
var spanAttributesSchema = import_zod12.z.object({
  name: import_zod12.z.string().nullish().describe("Name of the span, for display purposes only"),
...
function generateBaseEventOpSchema(objectType) {
  ...
  return import_zod12.z.object({
    ...
    [TRANSACTION_ID_FIELD]: import_zod12.z.string().describe(
    ...
    tags: import_zod12.z.array(import_zod12.z.string()).nullish().describe("A list of tags to log"),
    scores: import_zod12.z.record(import_zod12.z.number().min(0).max(1).nullish()).nullish(),
    metadata: import_zod12.z.object({
      model: import_zod12.z.string().nullish().describe("The model used for this example")
    ...
    }).catchall(import_zod12.z.number()).nullish().describe(
    ...
    context: import_zod12.z.object({
      caller_functionname: import_zod12.z.string().nullish().describe(
        `The function in code which created the ${eventDescription} event`
      ),
      caller_filename: import_zod12.z.string().nullish().describe(
        `Name of the file in code where the ${eventDescription} event was created`
      ),
      caller_lineno: import_zod12.z.number().int().nullish().describe(
    ...
    span_id: import_zod12.z.string().describe(
    ...
    span_parents: import_zod12.z.string().array().nullish().describe(
    ...
    root_span_id: import_zod12.z.string().describe(
    ...
    [OBJECT_DELETE_FIELD]: import_zod12.z.boolean().nullish().describe(
    ...
    is_root: import_zod12.z.boolean().nullish().describe(`Whether this span is a root span`)
  });
}
function generateBaseEventFeedbackSchema(objectType) {
  ...
  return import_zod12.z.object({
    ...
    scores: import_zod12.z.record(import_zod12.z.number().min(0).max(1).nullish()).nullish().describe(
    ...
    tags: import_zod12.z.array(import_zod12.z.string()).nullish().describe("A list of tags to log"),
    comment: import_zod12.z.string().nullish().describe(
      `An optional comment string to log about the ${eventDescription} event`
    ),
    metadata: import_zod12.z.record(customTypes.unknown).nullish().describe(
...
var fetchLimitParamSchema = import_zod12.z.coerce.number().int().nonnegative().describe(
  [
...
var maxXactIdSchema = import_zod12.z.string().describe(fetchPaginationCursorDescription).openapi("MaxXactId");
var maxRootSpanIdSchema = import_zod12.z.string().describe(fetchPaginationCursorDescription).openapi("MaxRootSpanId");
var fetchPaginationCursorSchema = import_zod12.z.string().describe(
  [
...
var versionSchema = import_zod12.z.string().describe(
  [
...
var fetchEventsRequestSchema = import_zod12.z.object({
...
function makeFetchEventsResponseSchema(objectType, eventSchema) {
  ...
  return import_zod12.z.object({
    ...
    cursor: import_zod12.z.string().nullish().describe(
      [
        "Pagination cursor",
...
var experimentEventSchema = import_zod12.z.object({
...
var datasetEventSchema = import_zod12.z.object({
...
var promptSessionEventSchema = import_zod12.z.object({
...
var projectLogsLogIdLiteralSchema = import_zod12.z.literal("g").describe("A literal 'g' which identifies the log as a project log");
var projectLogsEventSchema = import_zod12.z.object({
...
var insertSystemControlFieldsSchema = import_zod12.z.object({
  [IS_MERGE_FIELD]: import_zod12.z.boolean().nullish().describe(
    [
  ...
  [MERGE_PATHS_FIELD]: import_zod12.z.string().array().array().nullish().describe(
    [
  ...
  _parent_id: import_zod12.z.string().nullish().describe(
    [
  ...
  span_id: import_zod12.z.string().nullish().describe(spanIdsDescription),
  root_span_id: import_zod12.z.string().nullish().describe(spanIdsDescription),
  span_parents: import_zod12.z.string().array().nullish().describe(spanIdsDescription)
});
function makeInsertEventSchemas(objectType, insertSchema) {
  ...
  const requestSchema = import_zod12.z.object({
...
var insertEventsResponseSchema = import_zod12.z.object({
  row_ids: import_zod12.z.string().array().describe(
    "The ids of all rows that were inserted, aligning one-to-one with the rows provided as input"
  )
}).openapi("InsertEventsResponse");
var feedbackResponseSchema = import_zod12.z.object({
...
function makeCrossObjectIndividualRequestSchema(objectType) {
  ...
  const insertObject = import_zod12.z.object({
  ...
  return import_zod12.z.record(import_zod12.z.string().uuid(), insertObject).nullish().describe(
...
function makeCrossObjectIndividualResponseSchema(objectType) {
  return import_zod12.z.record(import_zod12.z.string().uuid(), insertEventsResponseSchema).nullish().describe(
    `A mapping from ${objectType} id to row ids for inserted \`events\``
  );
}
var crossObjectInsertRequestSchema = import_zod12.z.object({
...
var crossObjectInsertResponseSchema = import_zod12.z.object({
...
var summarizeScoresParamSchema = import_zod12.z.coerce.boolean().describe(
  "Whether to summarize the scores and metrics. If false (or omitted), only the metadata will be returned."
);
var comparisonExperimentIdParamSchema = import_zod12.z.string().uuid().describe(
...
var summarizeDataParamSchema = import_zod12.z.coerce.boolean().describe(
  "Whether to summarize the data. If false (or omitted), only the metadata will be returned."
);
var summarizeExperimentResponseSchema = import_zod12.z.object({
  project_name: import_zod12.z.string().describe("Name of the project that the experiment belongs to"),
  experiment_name: import_zod12.z.string().describe("Name of the experiment"),
  project_url: import_zod12.z.string().url().describe("URL to the project's page in the Braintrust app"),
  experiment_url: import_zod12.z.string().url().describe("URL to the experiment's page in the Braintrust app"),
  comparison_experiment_name: import_zod12.z.string().nullish().describe("The experiment which scores are baselined against"),
  scores: import_zod12.z.record(
    import_zod12.z.object({
      name: import_zod12.z.string().describe("Name of the score"),
      score: import_zod12.z.number().min(0).max(1).describe("Average score across all examples"),
      diff: import_zod12.z.number().min(-1).max(1).optional().describe(
        "Difference in score between the current and comparison experiment"
      ),
      improvements: import_zod12.z.number().int().min(0).describe("Number of improvements in the score"),
      regressions: import_zod12.z.number().int().min(0).describe("Number of regressions in the score")
    }).describe("Summary of a score's performance").openapi("ScoreSummary")
  ).nullish().describe("Summary of the experiment's scores"),
  metrics: import_zod12.z.record(
    import_zod12.z.object({
      name: import_zod12.z.string().describe("Name of the metric"),
      metric: import_zod12.z.number().describe("Average metric across all examples"),
      unit: import_zod12.z.string().describe("Unit label for the metric"),
      diff: import_zod12.z.number().optional().describe(
        "Difference in metric between the current and comparison experiment"
      ),
      improvements: import_zod12.z.number().int().min(0).describe("Number of improvements in the metric"),
      regressions: import_zod12.z.number().int().min(0).describe("Number of regressions in the metric")
...
var summarizeDatasetResponseSchema = import_zod12.z.object({
  project_name: import_zod12.z.string().describe("Name of the project that the dataset belongs to"),
  dataset_name: import_zod12.z.string().describe("Name of the dataset"),
  project_url: import_zod12.z.string().url().describe("URL to the project's page in the Braintrust app"),
  dataset_url: import_zod12.z.string().url().describe("URL to the dataset's page in the Braintrust app"),
  data_summary: import_zod12.z.object({
    total_records: import_zod12.z.number().int().min(0).describe("Total number of records in the dataset")
...
var asyncScoringStateSchema = import_zod12.z.union([
  import_zod12.z.object({
    status: import_zod12.z.literal("enabled"),
    token: import_zod12.z.string(),
    function_ids: import_zod12.z.array(functionIdSchema).nonempty()
  }),
  // Explicitly disabled.
  import_zod12.z.object({
    status: import_zod12.z.literal("disabled")
  }),
  // Inactive but may be selected later.
  import_zod12.z.null()
]).openapi("AsyncScoringState");
var asyncScoringControlSchema = import_zod12.z.discriminatedUnion("kind", [
  import_zod12.z.object({
    kind: import_zod12.z.literal("score_update"),
    token: import_zod12.z.string()
  }),
  import_zod12.z.object({
    kind: import_zod12.z.literal("state_override"),
    state: asyncScoringStateSchema
  }),
  import_zod12.z.object({
    kind: import_zod12.z.literal("state_force_reselect")
  })
...
var EXTERNAL_ATTACHMENT = "external_attachment";
var braintrustAttachmentReferenceSchema = import_zod13.z.object({
  type: import_zod13.z.literal(BRAINTRUST_ATTACHMENT).describe("An identifier to help disambiguate parsing."),
  filename: import_zod13.z.string().min(1).describe(
    "Human-readable filename for user interfaces. Not related to attachment storage."
  ),
  content_type: import_zod13.z.string().min(1).describe("MIME type of this file."),
  key: import_zod13.z.string().min(1).describe("Key in the object store bucket for this attachment.")
}).openapi("BraintrustAttachmentReference");
var externalAttachmentReferenceSchema = import_zod13.z.object({
  type: import_zod13.z.literal(EXTERNAL_ATTACHMENT).describe("An identifier to help disambiguate parsing."),
  filename: import_zod13.z.string().min(1).describe(
    "Human-readable filename for user interfaces. Not related to attachment storage."
  ),
  content_type: import_zod13.z.string().min(1).describe("MIME type of this file."),
  url: import_zod13.z.string().min(1).describe(
    "Fully qualified URL to the object in the external object store."
  )
}).openapi("ExternalAttachmentReference");
var attachmentReferenceSchema = import_zod13.z.discriminatedUnion("type", [
  braintrustAttachmentReferenceSchema,
  externalAttachmentReferenceSchema
]).openapi("AttachmentReference");
var uploadStatusSchema = import_zod13.z.enum(["uploading", "done", "error"]).openapi("UploadStatus");
var attachmentStatusSchema = import_zod13.z.object({
  upload_status: uploadStatusSchema,
  error_message: import_zod13.z.string().nullish().transform((x) => x || void 0).describe("Describes the error encountered while uploading.")
