...
var objectReferenceSchema = z2.object({
  object_type: eventObjectType.describe(
    "Type of the object the event is originating from."
  ),
  object_id: z2.string().uuid().describe("ID of the object the event is originating from."),
  id: z2.string().describe("ID of the original event."),
  _xact_id: z2.string().describe("Transaction ID of the original event."),
  created: z2.string().nullish().describe(
...
var responseFormatJsonSchemaSchema = z7.object({
  name: z7.string(),
  description: z7.string().optional(),
  schema: z7.union([
    z7.record(customTypes.unknown).openapi({ title: "object" }),
    z7.string().openapi({ title: "string" })
  ]).optional(),
  strict: z7.boolean().nullish()
});
var responseFormatSchema = z7.union([
...
var openAIModelParamsSchema = z7.object({
  ...
  max_completion_tokens: z7.number().optional().describe("The successor to max_tokens"),
  ...
  reasoning_effort: z7.enum(["low", "medium", "high"]).optional()
});
...
var viewOptionsSchema = z8.object({
  ...
  grouping: z8.string().nullish(),
  rowHeight: z8.string().nullish(),
  layout: z8.string().nullish()
...
var invokeParent = z10.union([
  z10.object({
    object_type: z10.enum(["project_logs", "experiment", "playground_logs"]),
...
var invokeFunctionNonIdArgsSchema = z10.object({
  ...
  metadata: z10.record(z10.string(), z10.unknown()).nullish().describe("Any relevant metadata"),
...
var runEvalSchema = z10.object({
  ...
  data: z10.union([
    z10.object({
      ...
      _internal_btql: z10.record(z10.string(), z10.unknown()).nullish()
...
var toolFunctionDefinitionSchema = z10.object({
  type: z10.literal("function"),
  function: z10.object({
    name: z10.string(),
    description: z10.string().optional(),
    parameters: z10.record(z10.unknown()).optional(),
    strict: z10.boolean().optional()
  })
});
...
var spanFieldOrderItem = z11.object({
  object_type: z11.string(),
  column_id: z11.string(),
  position: z11.string(),
  layout: z11.literal("full").or(z11.literal("two_column")).nullish()
});
var projectSettingsSchema = z11.object({
  ...
  baseline_experiment_id: z11.string().uuid().nullish().describe(
    "The id of the experiment to use as the default baseline for comparisons"
  ),
  spanFieldOrder: z11.array(spanFieldOrderItem).nullish().describe("The order of the fields to display in the trace view")
...
var playgroundLogsLogIdLiteralSchema = z11.literal("x").describe("A literal 'x' which identifies the object as a playground log");
...
var projectScoreTypeEnum = z11.enum([
  "slider",
  "categorical",
  "weighted",
  "minimum",
...
var projectScoreSchema = z11.object({
  ...
  config: z11.object({
    ...
    destination: z11.string().nullish(),
...
function generateBaseEventOpSchema(objectType) {
  ...
  return z12.object({
    ...
    metadata: z12.object({
      model: z12.string().nullish().describe("The model used for this example")
...
var insertSystemControlFieldsSchema = z12.object({
  ...
  _parent_id: z12.string().nullish().describe(
    [
...
var braintrustAttachmentReferenceSchema = z13.object({
...
var externalAttachmentReferenceSchema = z13.object({
  type: z13.literal(EXTERNAL_ATTACHMENT).describe("An identifier to help disambiguate parsing."),
  filename: z13.string().min(1).describe(
    "Human-readable filename for user interfaces. Not related to attachment storage."
  ),
  content_type: z13.string().min(1).describe("MIME type of this file."),
  url: z13.string().min(1).describe(
    "Fully qualified URL to the object in the external object store."
  )
}).openapi("ExternalAttachmentReference");
var attachmentReferenceSchema = z13.discriminatedUnion("type", [
